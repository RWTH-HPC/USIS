...
\begin{funcdef}{MPI\_ABI\_GET\_VERSION}{(\mbox{abi\_major}, \mbox{abi\_minor})}
\funcarg{\OUT}{abi\_major}{ABI major version (integer)}
\funcarg{\OUT}{abi\_minor}{ABI minor version (integer)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_get\_version}{(\gb{}int~*abi\_major, int~*abi\_minor)}
\mpifnewbindmain{MPI\_Abi\_get\_version}{(abi\_major, abi\_minor, ierror) \fargs INTEGER, INTENT(OUT)\ ::\ \mbox{abi\_major}, \mbox{abi\_minor}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_GET\_VERSION}{(ABI\_MAJOR, ABI\_MINOR, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{ABI\_MAJOR}, \mbox{ABI\_MINOR}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ABI\_GET\_INFO}{(\mbox{info})}
\funcarg{\OUT}{info}{ABI details info object (implementation-defined) (handle)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_get\_info}{(\gb{}MPI\_Info~*info)}
\mpifnewbindmain{MPI\_Abi\_get\_info}{(info, ierror) \fargs TYPE(MPI\_Info), INTENT(OUT)\ ::\ \mbox{info}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_GET\_INFO}{(INFO, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INFO}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ABI\_SET\_FORTRAN\_INFO}{(\mbox{info})}
\funcarg{\IN}{info}{Fortran ABI details info object (handle)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_set\_fortran\_info}{(\gb{}MPI\_Info~info)}
\mpifnewbindmain{MPI\_Abi\_set\_fortran\_info}{(info, ierror) \fargs TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_SET\_FORTRAN\_INFO}{(INFO, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INFO}, \mbox{IERROR}}

\begin{funcdef}{MPI\_ABI\_GET\_FORTRAN\_INFO}{(\mbox{info})}
\funcarg{\OUT}{info}{Fortran ABI details info object (handle)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_get\_fortran\_info}{(\gb{}MPI\_Info~*info)}
\mpifnewbindmain{MPI\_Abi\_get\_fortran\_info}{(info, ierror) \fargs TYPE(MPI\_Info), INTENT(OUT)\ ::\ \mbox{info}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_GET\_FORTRAN\_INFO}{(INFO, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INFO}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ABI\_SET\_FORTRAN\_BOOLEANS}{(\mbox{logical\_size}, \mbox{logical\_true}, \mbox{logical\_false})}
\funcarg{\IN}{logical\_size}{the size of Fortran \code{LOGICAL} in bytes (integer)}
\funcarg{\IN}{logical\_true}{the Fortran literal value \code{.TRUE.} (logical)}
\funcarg{\IN}{logical\_false}{the Fortran literal value \code{.FALSE.} (logical)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_set\_fortran\_booleans}{(\gb{}int~logical\_size, void~*logical\_true, void~*logical\_false)}
\mpifnewbindmain{MPI\_Abi\_set\_fortran\_booleans}{(logical\_size, logical\_true, logical\_false, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{logical\_size}\fnarg{}LOGICAL, INTENT(IN)\ ::\ \mbox{logical\_true}, \mbox{logical\_false}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_SET\_FORTRAN\_BOOLEANS}{(LOGICAL\_SIZE, LOGICAL\_TRUE, LOGICAL\_FALSE, IERROR) \fargs INTEGER \mbox{LOGICAL\_SIZE}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{LOGICAL\_TRUE}, \mbox{LOGICAL\_FALSE}}

\begin{funcdef}{MPI\_ABI\_GET\_FORTRAN\_BOOLEANS}{(\mbox{logical\_size}, \mbox{logical\_true}, \mbox{logical\_false}, \mbox{is\_set})}
\funcarg{\IN}{logical\_size}{the size of Fortran \code{LOGICAL} in bytes (integer)}
\funcarg{\OUT}{logical\_true}{the Fortran literal value \code{.TRUE.} (logical)}
\funcarg{\OUT}{logical\_false}{the Fortran literal value \code{.FALSE.} (logical)}
\funcarg{\OUT}{is\_set}{flag to indicate whether the logical boolean values were set previously (logical)}
\end{funcdef}
\mpibindmain{MPI\_Abi\_get\_fortran\_booleans}{(\gb{}int~logical\_size, void~*logical\_true, void~*logical\_false, int~*is\_set)}
\mpifnewbindmain{MPI\_Abi\_get\_fortran\_booleans}{(logical\_size, logical\_true, logical\_false, is\_set, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{logical\_size}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{logical\_true}, \mbox{logical\_false}, \mbox{is\_set}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ABI\_GET\_FORTRAN\_BOOLEANS}{(LOGICAL\_SIZE, LOGICAL\_TRUE, LOGICAL\_FALSE, IS\_SET, IERROR) \fargs INTEGER \mbox{LOGICAL\_SIZE}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{LOGICAL\_TRUE}, \mbox{LOGICAL\_FALSE}, \mbox{IS\_SET}}
...
\mpiemptybindidx{MPI\_Comm\_toint}{(\gb{}MPI\_Comm~comm)}{int}{MPI\_COMM\_TOINT}
...
\mpiemptybindidx{MPI\_Comm\_fromint}{(\gb{}int~comm)}{MPI\_Comm}{MPI\_COMM\_FROMINT}
...
\bindingislisttrue
\mpiemptybindidx{MPI\_Type\_fromint}{(\gb{}int~datatype)}{MPI\_Datatype}{MPI\_TYPE\_FROMINT}

\mpiemptybindidx{MPI\_Type\_toint}{(\gb{}MPI\_Datatype~datatype)}{int}{MPI\_TYPE\_TOINT}

\cdeclindex{MPI\_Group}%

\mpiemptybindidx{MPI\_Group\_fromint}{(\gb{}int~group)}{MPI\_Group}{MPI\_GROUP\_FROMINT}

\cdeclindex{MPI\_Group}%
\mpiemptybindidx{MPI\_Group\_toint}{(\gb{}MPI\_Group~group)}{int}{MPI\_GROUP\_TOINT}

\cdeclindex{MPI\_Request}%
\mpiemptybindidx{MPI\_Request\_fromint}{(\gb{}int~request)}{MPI\_Request}{MPI\_REQUEST\_FROMINT}

\cdeclindex{MPI\_Request}%
\mpiemptybindidx{MPI\_Request\_toint}{(\gb{}MPI\_Request~request)}{int}{MPI\_REQUEST\_TOINT}

\cdeclindex{MPI\_File}%
\mpiemptybindidx{MPI\_File\_fromint}{(\gb{}int~file)}{MPI\_File}{MPI\_FILE\_FROMINT}

\cdeclindex{MPI\_File}%
\mpiemptybindidx{MPI\_File\_toint}{(\gb{}MPI\_File~file)}{int}{MPI\_FILE\_TOINT}

\cdeclindex{MPI\_Win}%
\mpiemptybindidx{MPI\_Win\_fromint}{(\gb{}int~win)}{MPI\_Win}{MPI\_WIN\_FROMINT}

\cdeclindex{MPI\_Win}%
\mpiemptybindidx{MPI\_Win\_toint}{(\gb{}MPI\_Win~win)}{int}{MPI\_WIN\_TOINT}

\cdeclindex{MPI\_Op}%
\mpiemptybindidx{MPI\_Op\_fromint}{(\gb{}int~op)}{MPI\_Op}{MPI\_OP\_FROMINT}

\cdeclindex{MPI\_Op}%
\mpiemptybindidx{MPI\_Op\_toint}{(\gb{}MPI\_Op~op)}{int}{MPI\_OP\_TOINT}

\cdeclindex{MPI\_Info}%
\mpiemptybindidx{MPI\_Info\_fromint}{(\gb{}int~info)}{MPI\_Info}{MPI\_INFO\_FROMINT}

\cdeclindex{MPI\_Info}%
\mpiemptybindidx{MPI\_Info\_toint}{(\gb{}MPI\_Info~info)}{int}{MPI\_INFO\_TOINT}

\cdeclindex{MPI\_Errhandler}%
\mpiemptybindidx{MPI\_Errhandler\_fromint}{(\gb{}int~errhandler)}{MPI\_Errhandler}{MPI\_ERRHANDLER\_FROMINT}

\cdeclindex{MPI\_Errhandler}%
\mpiemptybindidx{MPI\_Errhandler\_toint}{(\gb{}MPI\_Errhandler~errhandler)}{int}{MPI\_ERRHANDLER\_TOINT}

\cdeclindex{MPI\_Message}%
\mpiemptybindidx{MPI\_Message\_fromint}{(\gb{}int~message)}{MPI\_Message}{MPI\_MESSAGE\_FROMINT}

\cdeclindex{MPI\_Message}%
\mpiemptybindidx{MPI\_Message\_toint}{(\gb{}MPI\_Message~message)}{int}{MPI\_MESSAGE\_TOINT}

\cdeclindex{MPI\_Session}%
\mpiemptybindidx{MPI\_Session\_fromint}{(\gb{}int~session)}{MPI\_Session}{MPI\_SESSION\_FROMINT}

\bindingislistfalse
\cdeclindex{MPI\_Session}%
\mpiemptybindidx{MPI\_Session\_toint}{(\gb{}MPI\_Session~session)}{int}{MPI\_SESSION\_TOINT}
