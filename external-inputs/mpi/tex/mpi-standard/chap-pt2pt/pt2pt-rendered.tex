...
\begin{funcdef}{MPI\_SEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm})}
...
\end{funcdef}
\mpibindmain{MPI\_Send}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Send\_c}
\mpibindmain{MPI\_Send\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Send}{(buf, count, datatype, dest, tag, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Send}{(buf, count, datatype, dest, tag, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_RECV}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{status})}
\funcarg{\OUT}{buf}{initial address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each receive buffer element (handle)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Recv}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Status~*status)}
\MPIbindindex{MPI\_Recv\_c}
\mpibindmain{MPI\_Recv\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Recv}{(buf, count, datatype, source, tag, comm, status, ierror) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_RECV}{(BUF, COUNT, DATATYPE, SOURCE, TAG, COMM, STATUS, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_GET\_COUNT}{(\mbox{status}, \mbox{datatype}, \mbox{count})}
\funcarg{\IN}{status}{return status of receive operation (status)}
\funcarg{\IN}{datatype}{datatype of each receive buffer entry (handle)}
\funcarg{\OUT}{count}{number of received entries (integer)}
\end{funcdef}
\mpibindmain{MPI\_Get\_count}{(\gb{}const~MPI\_Status~*status, MPI\_Datatype~datatype, int~*count)}
\MPIbindindex{MPI\_Get\_count\_c}
\mpibindmain{MPI\_Get\_count\_c}{(\gb{}const~MPI\_Status~*status, MPI\_Datatype~datatype, MPI\_Count~*count)}
\mpifnewbindmain{MPI\_Get\_count}{(status, datatype, count, ierror) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{count}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Get\_count}{(status, datatype, count, ierror) !(\_c) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(OUT)\ ::\ \mbox{count}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_GET\_COUNT}{(STATUS, DATATYPE, COUNT, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{DATATYPE}, \mbox{COUNT}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_GET\_SOURCE}{(\mbox{status}, \mbox{source})}
\funcarg{\IN}{status}{status from which to retrieve source rank (status)}
\funcarg{\OUT}{source}{rank set in the \mpiconst{MPI\_SOURCE} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_get\_source}{(\gb{}const~MPI\_Status~*status, int~*source)}
\mpifnewbindmain{MPI\_Status\_get\_source}{(status, source, ierror) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{source}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_GET\_SOURCE}{(STATUS, SOURCE, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{SOURCE}, \mbox{IERROR}}

Returns in \mpiarg{source} the value of the \mpiconst{MPI\_SOURCE} field in the \mpiarg{status} object.

\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_GET\_TAG}{(\mbox{status}, \mbox{tag})}
\funcarg{\IN}{status}{status from which to retrieve tag (status)}
\funcarg{\OUT}{tag}{tag set in the \mpiconst{MPI\_TAG} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_get\_tag}{(\gb{}const~MPI\_Status~*status, int~*tag)}
\mpifnewbindmain{MPI\_Status\_get\_tag}{(status, tag, ierror) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{tag}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_GET\_TAG}{(STATUS, TAG, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{TAG}, \mbox{IERROR}}

Returns in \mpiarg{tag} the value in the \mpiconst{MPI\_TAG} field of the \mpiarg{status} object.


\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_GET\_ERROR}{(\mbox{status}, \mbox{err})}
\funcarg{\IN}{status}{status from which to retrieve error (status)}
\funcarg{\OUT}{err}{error set in the \mpiconst{MPI\_ERROR} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_get\_error}{(\gb{}const~MPI\_Status~*status, int~*err)}
\mpifnewbindmain{MPI\_Status\_get\_error}{(status, err, ierror) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{err}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_GET\_ERROR}{(STATUS, ERR, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{ERR}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_SENDRECV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{dest}, \mbox{sendtag}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{source}, \mbox{recvtag}, \mbox{comm}, \mbox{status})}
\funcarg{\IN}{sendbuf}{initial address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{type of elements in send buffer (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
\funcarg{\IN}{sendtag}{send tag (integer)}
\funcarg{\OUT}{recvbuf}{initial address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{recvtype}{type of elements receive buffer element (handle)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{recvtag}{receive tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Sendrecv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, int~dest, int~sendtag, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Status~*status)}
\MPIbindindex{MPI\_Sendrecv\_c}
\mpibindmain{MPI\_Sendrecv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, int~dest, int~sendtag, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Sendrecv}{(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source, recvtag, comm, status, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{dest}, \mbox{sendtag}, \mbox{recvcount}, \mbox{source}, \mbox{recvtag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_SENDRECV\_REPLACE}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{sendtag}, \mbox{source}, \mbox{recvtag}, \mbox{comm}, \mbox{status})}
\funcarg{\INOUT}{buf}{initial address of send and receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in send and receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{type of elements in send and receive buffer (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
\funcarg{\IN}{sendtag}{send message tag (integer)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{recvtag}{receive message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Sendrecv\_replace}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~sendtag, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Status~*status)}
\MPIbindindex{MPI\_Sendrecv\_replace\_c}
\mpibindmain{MPI\_Sendrecv\_replace\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~sendtag, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Sendrecv\_replace}{(buf, count, datatype, dest, sendtag, source, recvtag, comm, status, ierror) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{sendtag}, \mbox{source}, \mbox{recvtag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_SENDRECV\_REPLACE}{(BUF, COUNT, DATATYPE, DEST, SENDTAG, SOURCE, RECVTAG, COMM, STATUS, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{SENDTAG}, \mbox{SOURCE}, \mbox{RECVTAG}, \mbox{COMM}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_BSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Bsend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Bsend\_c}
\mpibindmain{MPI\_Bsend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Bsend}{(buf, count, datatype, dest, tag, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Bsend}{(buf, count, datatype, dest, tag, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_SSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ssend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Ssend\_c}
\mpibindmain{MPI\_Ssend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Ssend}{(buf, count, datatype, dest, tag, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Ssend}{(buf, count, datatype, dest, tag, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{IERROR}}

Send in synchronous mode.

\begin{funcdef}{MPI\_RSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Rsend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Rsend\_c}
\mpibindmain{MPI\_Rsend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Rsend}{(buf, count, datatype, dest, tag, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Rsend}{(buf, count, datatype, dest, tag, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_RSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_COMM\_ATTACH\_BUFFER}{(\mbox{comm}, \mbox{buffer}, \mbox{size})}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\IN}{buffer}{initial buffer address (choice)}
\funcarg{\IN}{size}{buffer size, in bytes (nonnegative integer)}
\end{funcdef}
\mpibindmain{MPI\_Comm\_attach\_buffer}{(\gb{}MPI\_Comm~comm, void~*buffer, int~size)}
\MPIbindindex{MPI\_Comm\_attach\_buffer\_c}
\mpibindmain{MPI\_Comm\_attach\_buffer\_c}{(\gb{}MPI\_Comm~comm, void~*buffer, MPI\_Count~size)}
\mpifnewbindmain{MPI\_Comm\_attach\_buffer}{(comm, buffer, size, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Comm\_attach\_buffer}{(comm, buffer, size, ierror) !(\_c) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_COMM\_ATTACH\_BUFFER}{(COMM, BUFFER, SIZE, IERROR) \fargs INTEGER \mbox{COMM}, \mbox{SIZE}, \mbox{IERROR}\fnfinalarg{}<type> \mbox{BUFFER(*)}}
...
\begin{funcdef}{MPI\_SESSION\_ATTACH\_BUFFER}{(\mbox{session}, \mbox{buffer}, \mbox{size})}
\funcarg{\IN}{session}{session (handle)}
\funcarg{\IN}{buffer}{initial buffer address (choice)}
\funcarg{\IN}{size}{buffer size, in bytes (nonnegative integer)}
\end{funcdef}
\mpibindmain{MPI\_Session\_attach\_buffer}{(\gb{}MPI\_Session~session, void~*buffer, int~size)}
\MPIbindindex{MPI\_Session\_attach\_buffer\_c}
\mpibindmain{MPI\_Session\_attach\_buffer\_c}{(\gb{}MPI\_Session~session, void~*buffer, MPI\_Count~size)}
\mpifnewbindmain{MPI\_Session\_attach\_buffer}{(session, buffer, size, ierror) \fargs TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Session\_attach\_buffer}{(session, buffer, size, ierror) !(\_c) \fargs TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SESSION\_ATTACH\_BUFFER}{(SESSION, BUFFER, SIZE, IERROR) \fargs INTEGER \mbox{SESSION}, \mbox{SIZE}, \mbox{IERROR}\fnfinalarg{}<type> \mbox{BUFFER(*)}}
...
\begin{funcdef}{MPI\_BUFFER\_ATTACH}{(\mbox{buffer}, \mbox{size})}
\funcarg{\IN}{buffer}{initial buffer address (choice)}
\funcarg{\IN}{size}{buffer size, in bytes (nonnegative integer)}
\end{funcdef}
\mpibindmain{MPI\_Buffer\_attach}{(\gb{}void~*buffer, int~size)}
\MPIbindindex{MPI\_Buffer\_attach\_c}
\mpibindmain{MPI\_Buffer\_attach\_c}{(\gb{}void~*buffer, MPI\_Count~size)}
\mpifnewbindmain{MPI\_Buffer\_attach}{(buffer, size, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Buffer\_attach}{(buffer, size, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BUFFER\_ATTACH}{(BUFFER, SIZE, IERROR) \fargs <type> \mbox{BUFFER(*)}\fnfinalarg{}INTEGER \mbox{SIZE}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_COMM\_DETACH\_BUFFER}{(\mbox{comm}, \mbox{buffer\_addr}, \mbox{size})}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{buffer\_addr}{initial buffer address (choice)}
\funcarg{\OUT}{size}{buffer size, in bytes (integer)}
\end{funcdef}
\mpibindmain{MPI\_Comm\_detach\_buffer}{(\gb{}MPI\_Comm~comm, void~*buffer\_addr, int~*size)}
\MPIbindindex{MPI\_Comm\_detach\_buffer\_c}
\mpibindmain{MPI\_Comm\_detach\_buffer\_c}{(\gb{}MPI\_Comm~comm, void~*buffer\_addr, MPI\_Count~*size)}
\mpifnewbindmain{MPI\_Comm\_detach\_buffer}{(comm, buffer\_addr, size, ierror) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Comm\_detach\_buffer}{(comm, buffer\_addr, size, ierror) !(\_c) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_COMM\_DETACH\_BUFFER}{(COMM, BUFFER\_ADDR, SIZE, IERROR) \fargs INTEGER \mbox{COMM}, \mbox{SIZE}, \mbox{IERROR}\fnfinalarg{}<type> \mbox{BUFFER\_ADDR(*)}}

Detach the communicator-specific buffer currently attached to the communicator.


\begin{funcdef}{MPI\_SESSION\_DETACH\_BUFFER}{(\mbox{session}, \mbox{buffer\_addr}, \mbox{size})}
\funcarg{\IN}{session}{session (handle)}
\funcarg{\OUT}{buffer\_addr}{initial buffer address (choice)}
\funcarg{\OUT}{size}{buffer size, in bytes (integer)}
\end{funcdef}
\mpibindmain{MPI\_Session\_detach\_buffer}{(\gb{}MPI\_Session~session, void~*buffer\_addr, int~*size)}
\MPIbindindex{MPI\_Session\_detach\_buffer\_c}
\mpibindmain{MPI\_Session\_detach\_buffer\_c}{(\gb{}MPI\_Session~session, void~*buffer\_addr, MPI\_Count~*size)}
\mpifnewbindmain{MPI\_Session\_detach\_buffer}{(session, buffer\_addr, size, ierror) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnarg{}TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Session\_detach\_buffer}{(session, buffer\_addr, size, ierror) !(\_c) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnarg{}TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SESSION\_DETACH\_BUFFER}{(SESSION, BUFFER\_ADDR, SIZE, IERROR) \fargs INTEGER \mbox{SESSION}, \mbox{SIZE}, \mbox{IERROR}\fnfinalarg{}<type> \mbox{BUFFER\_ADDR(*)}}

Detach the session-specific buffer currently attached to the session.

\begin{funcdef}{MPI\_BUFFER\_DETACH}{(\mbox{buffer\_addr}, \mbox{size})}
\funcarg{\OUT}{buffer\_addr}{initial buffer address (choice)}
\funcarg{\OUT}{size}{buffer size, in bytes (integer)}
\end{funcdef}
\mpibindmain{MPI\_Buffer\_detach}{(\gb{}void~*buffer\_addr, int~*size)}
\MPIbindindex{MPI\_Buffer\_detach\_c}
\mpibindmain{MPI\_Buffer\_detach\_c}{(\gb{}void~*buffer\_addr, MPI\_Count~*size)}
\mpifnewbindmain{MPI\_Buffer\_detach}{(buffer\_addr, size, ierror) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Buffer\_detach}{(buffer\_addr, size, ierror) !(\_c) \fargs USE, INTRINSIC\ ::\ ISO\_C\_BINDING, ONLY : C\_PTR \\ TYPE(C\_PTR), INTENT(OUT)\ ::\ \mbox{buffer\_addr}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(OUT)\ ::\ \mbox{size}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BUFFER\_DETACH}{(BUFFER\_ADDR, SIZE, IERROR) \fargs <type> \mbox{BUFFER\_ADDR(*)}\fnfinalarg{}INTEGER \mbox{SIZE}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_COMM\_FLUSH\_BUFFER}{(\mbox{comm})}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Comm\_flush\_buffer}{(\gb{}MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Comm\_flush\_buffer}{(comm, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_COMM\_FLUSH\_BUFFER}{(COMM, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_SESSION\_FLUSH\_BUFFER}{(\mbox{session})}
\funcarg{\IN}{session}{session (handle)}
\end{funcdef}
\mpibindmain{MPI\_Session\_flush\_buffer}{(\gb{}MPI\_Session~session)}
\mpifnewbindmain{MPI\_Session\_flush\_buffer}{(session, ierror) \fargs TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SESSION\_FLUSH\_BUFFER}{(SESSION, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{SESSION}, \mbox{IERROR}}
...
\begin{funcdefna}{MPI\_BUFFER\_FLUSH}{()}
\end{funcdefna}
\mpibindmain{MPI\_Buffer\_flush}{(void)}
\mpifnewbindmain{MPI\_Buffer\_flush}{(ierror) \fargs \fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BUFFER\_FLUSH}{(IERROR) \fargs \fnfinalarg{}INTEGER \mbox{IERROR}}
...
\begin{funcdef}{MPI\_COMM\_IFLUSH\_BUFFER}{(\mbox{comm}, \mbox{request})}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Comm\_iflush\_buffer}{(\gb{}MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Comm\_iflush\_buffer}{(comm, request, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_COMM\_IFLUSH\_BUFFER}{(COMM, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

\begin{funcdef}{MPI\_SESSION\_IFLUSH\_BUFFER}{(\mbox{session}, \mbox{request})}
\funcarg{\IN}{session}{session (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Session\_iflush\_buffer}{(\gb{}MPI\_Session~session, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Session\_iflush\_buffer}{(session, request, ierror) \fargs TYPE(MPI\_Session), INTENT(IN)\ ::\ \mbox{session}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SESSION\_IFLUSH\_BUFFER}{(SESSION, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{SESSION}, \mbox{REQUEST}, \mbox{IERROR}}

\begin{funcdef}{MPI\_BUFFER\_IFLUSH}{(\mbox{request})}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Buffer\_iflush}{(\gb{}MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Buffer\_iflush}{(request, ierror) \fargs TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BUFFER\_IFLUSH}{(REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ISEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Isend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Isend\_c}
\mpibindmain{MPI\_Isend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Isend}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_ISEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_IBSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ibsend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ibsend\_c}
\mpibindmain{MPI\_Ibsend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ibsend}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Ibsend}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IBSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_ISSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Issend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Issend\_c}
\mpibindmain{MPI\_Issend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Issend}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Issend}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ISSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Start\mpitermindex{send!start} a synchronous mode\mpitermindex{synchronous mode send!nonblocking} nonblocking send.

\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_IRSEND}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Irsend}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Irsend\_c}
\mpibindmain{MPI\_Irsend\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Irsend}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Irsend}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IRSEND}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Start\mpitermindex{send!start} a ready mode\mpitermindex{ready mode send!nonblocking} nonblocking send.


\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_IRECV}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\OUT}{buf}{initial address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each receive buffer element (handle)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Irecv}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Irecv\_c}
\mpibindmain{MPI\_Irecv\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Irecv}{(buf, count, datatype, source, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IRECV}{(BUF, COUNT, DATATYPE, SOURCE, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Start\mpitermindex{receive!start} a nonblocking receive\mpitermindex{receive!nonblocking}.

\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_ISENDRECV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{dest}, \mbox{sendtag}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{source}, \mbox{recvtag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{initial address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of each send buffer element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
\funcarg{\IN}{sendtag}{send tag (integer)}
\funcarg{\OUT}{recvbuf}{initial address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of each receive buffer element (handle)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{recvtag}{receive tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Isendrecv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, int~dest, int~sendtag, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Isendrecv\_c}
\mpibindmain{MPI\_Isendrecv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, int~dest, int~sendtag, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Isendrecv}{(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source, recvtag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{dest}, \mbox{sendtag}, \mbox{recvcount}, \mbox{source}, \mbox{recvtag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_ISENDRECV\_REPLACE}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{sendtag}, \mbox{source}, \mbox{recvtag}, \mbox{comm}, \mbox{request})}
\funcarg{\INOUT}{buf}{initial address of send and receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in send and receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{type of elements in send and receive buffer (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Isendrecv\_replace}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~sendtag, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Isendrecv\_replace\_c}
\mpibindmain{MPI\_Isendrecv\_replace\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~sendtag, int~source, int~recvtag, MPI\_Comm~comm, MPI\_Request~*request)}
...
\mpifbindmain{MPI\_ISENDRECV\_REPLACE}{(BUF, COUNT, DATATYPE, DEST, SENDTAG, SOURCE, RECVTAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{SENDTAG}, \mbox{SOURCE}, \mbox{RECVTAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_WAIT}{(\mbox{request}, \mbox{status})}
\funcarg{\INOUT}{request}{request (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Wait}{(\gb{}MPI\_Request~*request, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Wait}{(request, status, ierror) \fargs TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{request}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_WAIT}{(REQUEST, STATUS, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_TEST}{(\mbox{request}, \mbox{flag}, \mbox{status})}
\funcarg{\INOUT}{request}{communication request (handle)}
\funcarg{\OUT}{flag}{\mpicode{true} if operation completed (logical)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Test}{(\gb{}MPI\_Request~*request, int~*flag, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Test}{(request, flag, status, ierror) \fargs TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{request}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TEST}{(REQUEST, FLAG, STATUS, IERROR) \fargs INTEGER \mbox{REQUEST}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_REQUEST\_FREE}{(\mbox{request})}
\funcarg{\INOUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Request\_free}{(\gb{}MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Request\_free}{(request, ierror) \fargs TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REQUEST\_FREE}{(REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_WAITANY}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{index}, \mbox{status})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{index}{index of handle for operation that completed (integer)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Waitany}{(\gb{}int~count, MPI\_Request~array\_of\_requests[], int~*index, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Waitany}{(count, array\_of\_requests, index, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{index}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_WAITANY}{(COUNT, ARRAY\_OF\_REQUESTS, INDEX, STATUS, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{INDEX}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_TESTANY}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{index}, \mbox{flag}, \mbox{status})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{index}{index of operation that completed or \mpiconst{MPI\_UNDEFINED} if none completed (integer)}
\funcarg{\OUT}{flag}{\mpicode{true} if one of the operations is complete (logical)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Testany}{(\gb{}int~count, MPI\_Request~array\_of\_requests[], int~*index, int~*flag, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Testany}{(count, array\_of\_requests, index, flag, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{index}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TESTANY}{(COUNT, ARRAY\_OF\_REQUESTS, INDEX, FLAG, STATUS, IERROR) \fargs INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{INDEX}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_WAITALL}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Waitall}{(\gb{}int~count, MPI\_Request~array\_of\_requests[], MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Waitall}{(count, array\_of\_requests, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_WAITALL}{(COUNT, ARRAY\_OF\_REQUESTS, ARRAY\_OF\_STATUSES, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_TESTALL}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{flag}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{flag}{\mpicode{true} if all of the operations are complete (logical)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Testall}{(\gb{}int~count, MPI\_Request~array\_of\_requests[], int~*flag, MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Testall}{(count, array\_of\_requests, flag, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TESTALL}{(COUNT, ARRAY\_OF\_REQUESTS, FLAG, ARRAY\_OF\_STATUSES, IERROR) \fargs INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_WAITSOME}{(\mbox{incount}, \mbox{array\_of\_requests}, \mbox{outcount}, \mbox{array\_of\_indices}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{incount}{length of array\_of\_requests (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{outcount}{number of completed requests (integer)}
\funcarg{\OUT}{array\_of\_indices}{array of indices of operations that completed (array of integers)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects for operations that completed (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Waitsome}{(\gb{}int~incount, MPI\_Request~array\_of\_requests[], int~*outcount, int~array\_of\_indices[], MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Waitsome}{(incount, array\_of\_requests, outcount, array\_of\_indices, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{incount}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(incount)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{outcount}, \mbox{array\_of\_indices(*)}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_WAITSOME}{(INCOUNT, ARRAY\_OF\_REQUESTS, OUTCOUNT, ARRAY\_OF\_INDICES, ARRAY\_OF\_STATUSES, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INCOUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{OUTCOUNT}, \mbox{ARRAY\_OF\_INDICES(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_TESTSOME}{(\mbox{incount}, \mbox{array\_of\_requests}, \mbox{outcount}, \mbox{array\_of\_indices}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{incount}{length of array\_of\_requests (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{outcount}{number of completed requests (integer)}
\funcarg{\OUT}{array\_of\_indices}{array of indices of operations that completed (array of integers)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects for operations that completed (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Testsome}{(\gb{}int~incount, MPI\_Request~array\_of\_requests[], int~*outcount, int~array\_of\_indices[], MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Testsome}{(incount, array\_of\_requests, outcount, array\_of\_indices, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{incount}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(incount)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{outcount}, \mbox{array\_of\_indices(*)}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TESTSOME}{(INCOUNT, ARRAY\_OF\_REQUESTS, OUTCOUNT, ARRAY\_OF\_INDICES, ARRAY\_OF\_STATUSES, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INCOUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{OUTCOUNT}, \mbox{ARRAY\_OF\_INDICES(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_REQUEST\_GET\_STATUS}{(\mbox{request}, \mbox{flag}, \mbox{status})}
\funcarg{\IN}{request}{request (handle)}
\funcarg{\OUT}{flag}{boolean flag, same as from \mpifunc{MPI\_TEST} (logical)}
\funcarg{\OUT}{status}{status object if flag is true (status)}
\end{funcdef}
\mpibindmain{MPI\_Request\_get\_status}{(\gb{}MPI\_Request~request, int~*flag, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Request\_get\_status}{(request, flag, status, ierror) \fargs TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REQUEST\_GET\_STATUS}{(REQUEST, FLAG, STATUS, IERROR) \fargs INTEGER \mbox{REQUEST}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_REQUEST\_GET\_STATUS\_ANY}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{index}, \mbox{flag}, \mbox{status})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\IN}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{index}{index of operation that completed or \mpiconst{MPI\_UNDEFINED} if none completed (integer)}
\funcarg{\OUT}{flag}{\mpicode{true} if one of the operations is complete (logical)}
\funcarg{\OUT}{status}{status object if flag is true (status)}
\end{funcdef}
\mpibindmain{MPI\_Request\_get\_status\_any}{(\gb{}int~count, const~MPI\_Request~array\_of\_requests[], int~*index, int~*flag, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Request\_get\_status\_any}{(count, array\_of\_requests, index, flag, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{index}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REQUEST\_GET\_STATUS\_ANY}{(COUNT, ARRAY\_OF\_REQUESTS, INDEX, FLAG, STATUS, IERROR) \fargs INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{INDEX}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_REQUEST\_GET\_STATUS\_ALL}{(\mbox{count}, \mbox{array\_of\_requests}, \mbox{flag}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\IN}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{flag}{true if all of the operations are complete (logical)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Request\_get\_status\_all}{(\gb{}int~count, const~MPI\_Request~array\_of\_requests[], int~*flag, MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Request\_get\_status\_all}{(count, array\_of\_requests, flag, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{array\_of\_requests(count)}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REQUEST\_GET\_STATUS\_ALL}{(COUNT, ARRAY\_OF\_REQUESTS, FLAG, ARRAY\_OF\_STATUSES, IERROR) \fargs INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_REQUEST\_GET\_STATUS\_SOME}{(\mbox{incount}, \mbox{array\_of\_requests}, \mbox{outcount}, \mbox{array\_of\_indices}, \mbox{array\_of\_statuses})}
\funcarg{\IN}{incount}{length of array\_of\_requests (nonnegative integer)}
\funcarg{\IN}{array\_of\_requests}{array of requests (array of handles)}
\funcarg{\OUT}{outcount}{number of completed requests (integer)}
\funcarg{\OUT}{array\_of\_indices}{array of indices of operations that completed (array of integers)}
\funcarg{\OUT}{array\_of\_statuses}{array of status objects for operations that completed (array of status)}
\end{funcdef}
\mpibindmain{MPI\_Request\_get\_status\_some}{(\gb{}int~incount, const~MPI\_Request~array\_of\_requests[], int~*outcount, int~array\_of\_indices[], MPI\_Status~array\_of\_statuses[])}
\mpifnewbindmain{MPI\_Request\_get\_status\_some}{(incount, array\_of\_requests, outcount, array\_of\_indices, array\_of\_statuses, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{incount}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{array\_of\_requests(incount)}\fnarg{}INTEGER, INTENT(OUT)\ ::\ \mbox{outcount}, \mbox{array\_of\_indices(*)}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{array\_of\_statuses(*)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REQUEST\_GET\_STATUS\_SOME}{(INCOUNT, ARRAY\_OF\_REQUESTS, OUTCOUNT, ARRAY\_OF\_INDICES, ARRAY\_OF\_STATUSES, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{INCOUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{OUTCOUNT}, \mbox{ARRAY\_OF\_INDICES(*)}, \mbox{ARRAY\_OF\_STATUSES(MPI\_STATUS\_SIZE, *)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_IPROBE}{(\mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{flag}, \mbox{status})}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{flag}{\mpicode{true} if there is a matching message that can be received (logical)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Iprobe}{(\gb{}int~source, int~tag, MPI\_Comm~comm, int~*flag, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Iprobe}{(source, tag, comm, flag, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IPROBE}{(SOURCE, TAG, COMM, FLAG, STATUS, IERROR) \fargs INTEGER \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_PROBE}{(\mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{status})}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Probe}{(\gb{}int~source, int~tag, MPI\_Comm~comm, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Probe}{(source, tag, comm, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PROBE}{(SOURCE, TAG, COMM, STATUS, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IMPROBE}{(\mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{flag}, \mbox{message}, \mbox{status})}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{flag}{\mpicode{true} if there is a matching message that can be received (logical)}
\funcarg{\OUT}{message}{returned message (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Improbe}{(\gb{}int~source, int~tag, MPI\_Comm~comm, int~*flag, MPI\_Message~*message, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Improbe}{(source, tag, comm, flag, message, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnarg{}TYPE(MPI\_Message), INTENT(OUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IMPROBE}{(SOURCE, TAG, COMM, FLAG, MESSAGE, STATUS, IERROR) \fargs INTEGER \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{MESSAGE}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_MPROBE}{(\mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{message}, \mbox{status})}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{message}{returned message (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Mprobe}{(\gb{}int~source, int~tag, MPI\_Comm~comm, MPI\_Message~*message, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Mprobe}{(source, tag, comm, message, status, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Message), INTENT(OUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_MPROBE}{(SOURCE, TAG, COMM, MESSAGE, STATUS, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{MESSAGE}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_MRECV}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{message}, \mbox{status})}
\funcarg{\OUT}{buf}{initial address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each receive buffer element (handle)}
\funcarg{\INOUT}{message}{message (handle)}
\funcarg{\OUT}{status}{status object (status)}
\end{funcdef}
\mpibindmain{MPI\_Mrecv}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, MPI\_Message~*message, MPI\_Status~*status)}
\MPIbindindex{MPI\_Mrecv\_c}
\mpibindmain{MPI\_Mrecv\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Message~*message, MPI\_Status~*status)}
\mpifnewbindmain{MPI\_Mrecv}{(buf, count, datatype, message, status, ierror) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Message), INTENT(INOUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Mrecv}{(buf, count, datatype, message, status, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Message), INTENT(INOUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Status)\ ::\ \mbox{status}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_MRECV}{(BUF, COUNT, DATATYPE, MESSAGE, STATUS, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{MESSAGE}, \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IMRECV}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{message}, \mbox{request})}
\funcarg{\OUT}{buf}{initial address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of each receive buffer element (handle)}
\funcarg{\INOUT}{message}{message (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Imrecv}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, MPI\_Message~*message, MPI\_Request~*request)}
\MPIbindindex{MPI\_Imrecv\_c}
\mpibindmain{MPI\_Imrecv\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Message~*message, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Imrecv}{(buf, count, datatype, message, request, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Message), INTENT(INOUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Imrecv}{(buf, count, datatype, message, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Message), INTENT(INOUT)\ ::\ \mbox{message}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IMRECV}{(BUF, COUNT, DATATYPE, MESSAGE, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{MESSAGE}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_CANCEL}{(\mbox{request})}
\funcarg{\IN}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Cancel}{(\gb{}MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Cancel}{(request, ierror) \fargs TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_CANCEL}{(REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}
\begin{funcdef}{MPI\_TEST\_CANCELLED}{(\mbox{status}, \mbox{flag})}
\funcarg{\IN}{status}{status object (status)}
\funcarg{\OUT}{flag}{\mpicode{true} if the operation has been cancelled (logical)}
\end{funcdef}
\mpibindmain{MPI\_Test\_cancelled}{(\gb{}const~MPI\_Status~*status, int~*flag)}
\mpifnewbindmain{MPI\_Test\_cancelled}{(status, flag, ierror) \fargs TYPE(MPI\_Status), INTENT(IN)\ ::\ \mbox{status}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TEST\_CANCELLED}{(STATUS, FLAG, IERROR) \fargs INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_SEND\_INIT}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements sent (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
\funcarg{\IN}{tag}{message tag (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Send\_init}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Send\_init\_c}
\mpibindmain{MPI\_Send\_init\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Send\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Send\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SEND\_INIT}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_BSEND\_INIT}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements sent (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Bsend\_init}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Bsend\_init\_c}
\mpibindmain{MPI\_Bsend\_init\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Bsend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Bsend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BSEND\_INIT}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a \mpiterm{persistent communication request}
for a \mpiterm{buffered mode send} operation.

\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_SSEND\_INIT}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements sent (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ssend\_init}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ssend\_init\_c}
\mpibindmain{MPI\_Ssend\_init\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ssend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Ssend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SSEND\_INIT}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a \mpiterm{persistent communication request}
for a \mpiterm{synchronous mode send}\mpitermindex{synchronous mode send!persistent} operation.

\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_RSEND\_INIT}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{count}{number of elements sent (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
\funcarg{\IN}{dest}{rank of destination (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Rsend\_init}{(\gb{}const~void~*buf, int~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Rsend\_init\_c}
\mpibindmain{MPI\_Rsend\_init\_c}{(\gb{}const~void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Rsend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Rsend\_init}{(buf, count, datatype, dest, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{dest}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_RSEND\_INIT}{(BUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a \mpiterm{persistent communication request}
for a \mpiterm{ready mode send}\mpitermindex{ready mode send!persistent} operation.

\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_RECV\_INIT}{(\mbox{buf}, \mbox{count}, \mbox{datatype}, \mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{request})}
\funcarg{\OUT}{buf}{initial address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements received (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
\funcarg{\IN}{source}{rank of source or \mpiconst{MPI\_ANY\_SOURCE} (integer)}
\funcarg{\IN}{tag}{message tag or \mpiconst{MPI\_ANY\_TAG} (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Recv\_init}{(\gb{}void~*buf, int~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Recv\_init\_c}
\mpibindmain{MPI\_Recv\_init\_c}{(\gb{}void~*buf, MPI\_Count~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Recv\_init}{(buf, count, datatype, source, tag, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Recv\_init}{(buf, count, datatype, source, tag, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{source}, \mbox{tag}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_RECV\_INIT}{(BUF, COUNT, DATATYPE, SOURCE, TAG, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_START}{(\mbox{request})}
\funcarg{\INOUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Start}{(\gb{}MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Start}{(request, ierror) \fargs TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_START}{(REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_STARTALL}{(\mbox{count}, \mbox{array\_of\_requests})}
\funcarg{\IN}{count}{list length (nonnegative integer)}
\funcarg{\INOUT}{array\_of\_requests}{array of requests (array of handles)}
\end{funcdef}
\mpibindmain{MPI\_Startall}{(\gb{}int~count, MPI\_Request~array\_of\_requests[])}
\mpifnewbindmain{MPI\_Startall}{(count, array\_of\_requests, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Request), INTENT(INOUT)\ ::\ \mbox{array\_of\_requests(count)}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STARTALL}{(COUNT, ARRAY\_OF\_REQUESTS, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{ARRAY\_OF\_REQUESTS(*)}, \mbox{IERROR}}
