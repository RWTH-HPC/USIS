...
LIS_KIND_MAP = {
    ...
    # NNI is nonnegative integer
    'ARRAY_LENGTH'        : 'integer',
    'ARRAY_LENGTH_NNI'    : 'nonnegative integer',
    'ARRAY_LENGTH_PI'     : 'positive integer',
    'ATTRIBUTE_VAL_10'    : None, # From MPI-1.0
    'ATTRIBUTE_VAL'       : None, # Current version of MPI
    'BLOCKLENGTH'         : 'nonnegative integer',
    'COLOR'               : 'integer',
    'COORDINATE'          : 'integer',
    'COORDINATE_NNI'      : 'nonnegative integer',
    ...
    'ASSERT'              : 'integer',
    'WINDOW_SIZE'         : 'nonnegative integer',
    ...
    'ALLOC_MEM_NUM_BYTES' : 'nonnegative integer',
    ...
    'WIN_ATTACH_SIZE'     : 'nonnegative integer',
    ...
    'DISPLACEMENT_NNI'    : 'nonnegative integer',
    ...
    'NUM_BYTES_NNI_SMALL' : 'nonnegative integer',
    'NUM_BYTES_NNI'       : 'nonnegative integer',
    ...
    'RMA_DISPLACEMENT_NNI_SMALL': 'nonnegative integer',
    'RMA_DISPLACEMENT_NNI'      : 'nonnegative integer',
    'POLYRMA_DISPLACEMENT_NNI'  : 'nonnegative integer',
    ...
    'DTYPE_NUM_ELEM_NNI_SMALL': 'nonnegative integer',
    'DTYPE_NUM_ELEM_NNI'      : 'nonnegative integer',
    'POLYDTYPE_NUM_ELEM_NNI'  : 'nonnegative integer',
    ...
    'POLYNUM_BYTES_NNI'   : 'nonnegative integer',

    # For transfer procedures (e.g., MPI_Send, MPI_Broadcast, MPI_Put, etc.)
    'XFER_NUM_ELEM_NNI_SMALL': 'nonnegative integer',
    'XFER_NUM_ELEM_NNI'      : 'nonnegative integer',
    'POLYXFER_NUM_ELEM_NNI'  : 'nonnegative integer',
    ...
    'NUM_PARAM_VALUES_SMALL': 'nonnegative integer',
    'POLYNUM_PARAM_VALUES': 'nonnegative integer',
    'NUM_PARAM_VALUES': 'nonnegative integer',
