...
\begin{mpi-binding}
    function_name("MPI_T_init_thread")
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_enum_get_info")
    
    parameter("enumtype", "TOOLS_ENUM", desc=r"enumeration to be queried")
    parameter(
        "num",
        "TOOLENUM_SIZE",
        desc=r"number of discrete values represented by this enumeration",
        direction="out",
    )
    parameter(
        "name",
    ...
    parameter(
        "name_len",
        "STRING_LENGTH",
        desc=r"length of the string and/or buffer for \mpiarg{name}",
        direction="inout",
    )
...
\cdeclindex{MPI\_T\_enum}
\begin{mpi-binding}
    function_name("MPI_T_enum_get_item")
    
    parameter("enumtype", "TOOLS_ENUM", desc=r"enumeration to be queried")
    parameter(
        "index",
        "TOOLENUM_INDEX",
        desc=r"number of the value to be queried in this enumeration",
    )
    parameter("value", "TOOL_VAR_VALUE", desc=r"variable value", direction="out")
    parameter(
        "name",
        "STRING",
        desc=(
...
\begin{mpi-binding}
    function_name("MPI_T_cvar_get_num")
    
    parameter(
        "num_cvar",
        "CVAR_INDEX",
        desc=r"returns number of control variables",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_enum}
\begin{mpi-binding}
    function_name("MPI_T_cvar_get_info")
    ...
    parameter(
        ...
        "CVAR_INDEX",
        desc=(
            r"index of the control variable to be queried, value between "
            r"$0$ and $\mpiarg{num_cvar}-1$"
        ),
    )
    parameter(
        "name",
        "STRING",
        desc=(
            "buffer to return the string containing the name of the control "
            "variable"
        ),
        direction="out",
    )
    ...
    parameter(
        "verbosity",
        "TOOL_VAR_VERBOSITY",
        desc=r"verbosity level of this variable",
        direction="out",
    )
    parameter(
        "datatype",
        "DATATYPE",
        desc=r"\mpi/ datatype of the information stored in the control variable",
        direction="out",
    )
    parameter(
        "enumtype",
        "TOOLS_ENUM",
        desc=r"optional descriptor for enumeration information",
        direction="out",
    )
    parameter(
        "desc",
        "STRING",
        desc=(
            "buffer to return the string containing a description of the "
            "control variable"
        ),
        direction="out",
    )
    parameter(
        "desc_len",
        "STRING_LENGTH",
        desc=r"length of the string and/or buffer for \mpiarg{desc}",
        direction="inout",
    )
    parameter(
        "bind",
        "BIND_TYPE",
        desc=r"type of \mpi/ object to which this variable must be bound",
        direction="out",
    )
    parameter(
        "scope",
        "VARIABLE_SCOPE",
        desc=r"scope of when changes to this variable are possible",
        direction="out",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_cvar_get_index")
    parameter(
        "name", "STRING", desc=r"name of the control variable", constant=True
    )
    parameter(
        "cvar_index",
        "CVAR_INDEX",
        desc=r"index of the control variable",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_cvar_handle_alloc")
    parameter(
        "cvar_index",
        "CVAR_INDEX_SPECIAL",
        desc=r"index of control variable for which handle is to be allocated",
    )
    parameter(
        "obj_handle",
        "TOOL_MPI_OBJ",
        desc=(
            r"reference to a handle of the \mpi/ object to which this "
            r"variable is supposed to be bound"
        ),
    )
    parameter("handle", "CVAR", desc=r"allocated handle", direction="out")
    parameter(
        "count",
        "TOOLS_NUM_ELEM_SMALL",
        desc=r"number of elements used to represent this variable",
        direction="out",
    )
...
\cdeclindex{MPI\_T\_cvar\_handle}
\begin{mpi-binding}
    function_name("MPI_T_cvar_handle_free")
    parameter("handle", "CVAR", desc=r"handle to be freed", direction="inout")
    no_f90_binding()
    no_f08_binding()
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_cvar\_handle}
\begin{mpi-binding}
    function_name("MPI_T_cvar_read")
    parameter(
        "handle", "CVAR", desc=r"handle to the control variable to be read"
    )
    parameter(
        "buf",
        "BUFFER",
        desc=r"initial address of storage location for variable value",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_cvar\_handle}
\begin{mpi-binding}
    function_name("MPI_T_cvar_write")
    parameter(
        "handle",
        "CVAR",
        desc=r"handle to the control variable to be written",
...
\begin{mpi-binding}
    function_name("MPI_T_pvar_get_num")
    parameter(
        "num_pvar",
        "PVAR_INDEX",
        desc=r"returns number of performance variables",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_enum}
\begin{mpi-binding}
    function_name("MPI_T_pvar_get_info")
    parameter(
        "pvar_index",
        "PVAR_INDEX",
        desc=(
            r"index of the performance variable to be queried between "
            r"$0$ and $\mpiarg{num_pvar}-1$"
        ),
    )
    parameter(
        "name",
    ...
    parameter(
        "var_class",
        "PVAR_CLASS",
        desc=r"class of performance variable",
        direction="out",
    )
    parameter(
        "datatype",
        "DATATYPE",
        desc=(
            r"\mpi/ datatype of the information stored in the performance "
            r"variable"
        ),
        direction="out",
    )
    ...
    parameter(
        "readonly",
        "LOGICAL_OPTIONAL",
        desc=r"flag indicating whether the variable can be written/reset",
        direction="out",
    )
    parameter(
        "continuous",
    ...
    parameter(
        ...
        "LOGICAL_OPTIONAL",
        desc=(
            "flag indicating whether the variable can be atomically read "
            "and reset"
        ),
        direction="out",
    )
...
\begin{mpi-binding}
    function_name("MPI_T_pvar_get_index")
    parameter(
        "name",
        "STRING",
        desc=r"the name of the performance variable",
        constant=True,
    )
    parameter(
        "var_class", "PVAR_CLASS", desc=r"the class of the performance variable"
    )
    parameter(
        "pvar_index",
        "PVAR_INDEX",
        desc=r"the index of the performance variable",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_pvar_session_create")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_session_free")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_handle_alloc")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
    ...
    parameter("handle", "PVAR", desc=r"allocated handle", direction="out")
    parameter(
        "count",
        "TOOLS_NUM_ELEM_SMALL",
        desc=r"number of elements used to represent this variable",
...
\cdeclindex{MPI\_T\_pvar\_session}%
\begin{mpi-binding}
    function_name("MPI_T_pvar_handle_free")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
    ...
    parameter("handle", "PVAR", desc=r"handle to be freed", direction="inout")
    no_f90_binding()
    no_f08_binding()
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_pvar\_session} 
\begin{mpi-binding}
    function_name("MPI_T_pvar_start")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
    ...
    parameter(
        "handle",
        "PVAR",
        desc=r"handle of a performance variable",
        direction="lis:inout,param:in"
    )
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_read")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
    )
    parameter("handle", "PVAR", desc=r"handle of a performance variable")
    parameter(
        "buf",
        "BUFFER",
        desc=r"initial address of storage location for variable value",
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_write")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_reset")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
...
\cdeclindex{MPI\_T\_pvar\_session}
\begin{mpi-binding}
    function_name("MPI_T_pvar_readreset")
    parameter(
        "pe_session",
        "PVAR_SESSION",
        desc=r"identifier of performance experiment session",
...
\begin{mpi-binding}
    function_name("MPI_T_source_get_num")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "num_sources",
        "SOURCE_INDEX",
        desc=r"returns number of event sources",
        direction="out",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_source_get_info")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        ...
        "SOURCE_INDEX",
        desc=(
            r"index of the source to be queried between "
            r"$0$ and $\mpiarg{num_sources}-1$"
        ),
    )
    parameter(
        "name",
    ...
    parameter(
        ...
        "SOURCE_ORDERING",
        desc=(
            "flag indicating chronological ordering guarantees given by "
            "the source"
        ),
        direction="out",
    )
    parameter(
        "ticks_per_second",
        "TOOLS_TICK_COUNT",
        desc=r"the number of ticks per second for the timer of this source",
        direction="out",
    )
    parameter(
        "max_ticks",
...
\begin{mpi-binding}
    function_name("MPI_T_source_get_timestamp")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "source_index",
        "SOURCE_INDEX",
        desc=r"index of the source",
    )
    parameter(
        "timestamp",
        "TOOLS_TICK_COUNT",
        desc=r"current timestamp from specified source",
        direction="out",
    ),
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_event_get_num")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "num_events",
        "EVENT_INDEX",
        desc=r"returns number of event types",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_enum}
\begin{mpi-binding}
    function_name("MPI_T_event_get_info")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        ...
        "EVENT_INDEX",
        desc=(
            r"index of the event type to be queried between "
            r"$0$ and $\mpiarg{num_events}-1$"
        ),
    )
    parameter(
        "name",
    ...
    parameter(
        "verbosity",
        "TOOL_VAR_VERBOSITY",
        desc=r"verbosity level of this event type",
        direction="out",
    )
    parameter(
        "array_of_datatypes",
        "DATATYPE",
        desc=(
            r"array of \mpi/ basic datatypes used to encode the "
            r"event data"
        ),
        length="num_elements",
        direction="out",
    ...
    parameter(
        ...
        "DISPLACEMENT_NNI",
        desc=(
            "array of byte displacements of the elements in the "
            "event buffer"
        ),
        length="num_elements",
        direction="out",
    ...
    parameter(
        ...
        "ARRAY_LENGTH_NNI",
        desc=(
            r"length of \mpiarg{array\_of\_datatypes} and "
            r"\mpiarg{array\_of\_displacements} arrays"
        ),
        direction="inout",
    )
    parameter(
    ...
    parameter(
        "bind",
        "BIND_TYPE",
        desc=r"type of \mpi/ object to which an event of this type must be bound",
        direction="out",
    )
...
\begin{mpi-binding}
    function_name("MPI_T_event_get_index")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "name",
        "STRING",
        desc=r"name of the event type",
        constant=True,
    )
    parameter(
        "event_index",
        "EVENT_INDEX",
        desc=r"index of the event type",
        direction="out",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_event_handle_alloc")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        ...
        "EVENT_INDEX",
        desc=(
            "index of event type for which the registration handle "
            "is to be allocated"
        ),
    )
    parameter(
        ...
        desc=(
            r"reference to a handle of the \mpi/ object to which this "
            r"event is supposed to be bound"
        ),
    )
    parameter(
        "info",
...
\cdeclindex{MPI\_T\_event\_registration}
\begin{mpi-binding}
    function_name("MPI_T_event_handle_set_info")
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_event\_registration}
\begin{mpi-binding}
    function_name("MPI_T_event_handle_get_info")
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_event_register_callback")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "cb_safety",
        "CALLBACK_SAFETY",
        desc=r"maximum callback safety level"
    )
    parameter(
        "info",
        "INFO",
    ...
    parameter(
        "user_data",
        "EXTRA_STATE",
        desc=r"pointer to a user-controlled buffer",
    )
    parameter(
        "event_cb_function",
        "EVENT_CB_FUNCTION",
        desc=r"pointer to user-defined callback function",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    callback()
    function_name("MPI_T_event_cb_function")
    return_type("NOTHING")
    no_lis_binding()
    no_f90_binding()
    no_f08_binding()

    parameter("event_instance", "EVENT_INSTANCE", direction="in")
    parameter("event_registration", "EVENT_REGISTRATION", direction="in")
    parameter("cb_safety", "CALLBACK_SAFETY", direction="in")
    parameter("user_data", "EXTRA_STATE", direction="in")
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_event\_registration}
\begin{mpi-binding}
    function_name("MPI_T_event_callback_set_info")
    no_f90_binding()
    no_f08_binding()
...
\cdeclindex{MPI\_T\_event\_registration}
\begin{mpi-binding}
    function_name("MPI_T_event_callback_get_info")
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_event_handle_free")
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    callback()
    function_name("MPI_T_event_free_cb_function")
    return_type("NOTHING")
    no_lis_binding()
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_event_set_dropped_handler")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "event_registration",
        "EVENT_REGISTRATION",
        desc=r"valid event registration",
        direction="lis:inout,param:in",
    )
    parameter(
        "dropped_cb_function",
        "EVENT_DROP_CB_FUNCTION",
        desc=r"pointer to user-defined callback function",
    )
\end{mpi-binding}
\cdeclindex{MPI\_T\_event\_registration}
...
\begin{mpi-binding}
    callback()
    function_name("MPI_T_event_dropped_cb_function")
    return_type("NOTHING")
    no_lis_binding()
    no_f90_binding()
    no_f08_binding()

    parameter("count", "DROPPED_COUNT", direction="in")
    parameter("event_registration", "EVENT_REGISTRATION", direction="in")
    parameter("source_index", "SOURCE_INDEX", direction="in")
    parameter("cb_safety", "CALLBACK_SAFETY", direction="in")
    parameter("user_data", "EXTRA_STATE", direction="in")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_event_read")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "event_instance",
        "EVENT_INSTANCE",
        desc=r"event-instance handle provided to the callback function",
    )
    parameter(
        "element_index",
        "INDEX",
        desc=r"index into the array of datatypes of the item to be queried",
    )
    parameter(
        "buffer",
        "C_BUFFER",
        desc=r"pointer to a memory location to store the item data",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_event\_instance}
\begin{mpi-binding}
    function_name("MPI_T_event_copy")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "event_instance",
        "EVENT_INSTANCE",
        desc=r"event instance provided to the callback function",
    )
    parameter(
        "buffer",
        "C_BUFFER",
        desc=r"user-allocated buffer for event data",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_event\_instance}
\begin{mpi-binding}
    function_name("MPI_T_event_get_timestamp")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "event_timestamp",
        "TOOLS_TICK_COUNT",
        desc=r"timestamp the event was observed",
        direction="out",
    ),
\end{mpi-binding}
...
\cdeclindex{MPI\_T\_event\_instance}
\begin{mpi-binding}
    function_name("MPI_T_event_get_source")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "source_index",
        "SOURCE_INDEX",
        desc=r"index identifying the source",
        direction="out",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_num")
    parameter(
        "num_cat",
        "CAT_INDEX",
        desc=r"current number of categories",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_info")
    parameter(
        "cat_index", "CAT_INDEX", desc=r"index of the category to be queried"
    )
    parameter(
        "name",
        "STRING",
        desc=r"buffer to return the string containing the name of the category",
        direction="out",
    )
    parameter(
        "name_len",
    ...
    parameter(
        "num_cvars",
        "CVAR_INDEX",
        desc=r"number of control variables in the category",
        direction="out",
    )
    parameter(
        "num_pvars",
        "PVAR_INDEX",
        desc=r"number of performance variables in the category",
        direction="out",
    )
    parameter(
        "num_categories",
        "CAT_INDEX",
        desc=r"number of  categories contained in the category",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_num_events")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        "cat_index",
        "CAT_INDEX",
        desc=r"index of the category to be queried",
    )
    parameter(
        "num_events",
        "EVENT_INDEX",
        desc=r"number of event types in the category",
        direction="out",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_index")
    parameter("name", "STRING", desc=r"the name of the category", constant=True)
    parameter(
        "cat_index",
        "CAT_INDEX",
        desc=r"the index of the category",
        direction="out",
    )
    no_f90_binding()
    no_f08_binding()
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_cvars")
    parameter(
        "cat_index",
        "CAT_INDEX",
        desc=(
            r"index of the category to be queried, in the range "
            r"from $0$ to $\mpiarg{num_cat}-1$"
        ),
    )
    parameter("len", "ARRAY_LENGTH", desc=r"the length of the indices array")
    parameter(
        "indices",
        "CVAR_INDEX",
        desc=(
            r"an integer array of size \mpiarg{len}, indicating control "
            r"variable indices"
        ),
        direction="out",
        length="len",
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_pvars")
    parameter(
        "cat_index",
        "CAT_INDEX",
        desc=(
    ...
    parameter(
        ...
        "PVAR_INDEX",
        desc=(
            r"an integer array of size \mpiarg{len}, indicating performance "
            r"variable indices"
        ),
        direction="out",
        length="len",
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_events")
    no_f90_binding()
    no_f08_binding()
    ...
    parameter(
        ...
        "CAT_INDEX",
        desc=(
            r"index of the category to be queried, "
            r"in the range from $0$ to $\mpiarg{num_cat}-1$"
        ),
    )
    parameter("len", "ARRAY_LENGTH", desc=r"the length of the indices array")
    parameter(
        ...
        "CAT_INDEX",
        desc=(
            r"an integer array of size \mpiarg{len}, indicating event type "
            r"indices"
        ),
        direction="out",
        length="len",
...
\begin{mpi-binding}
    function_name("MPI_T_category_get_categories")
    parameter(
        "cat_index",
        "CAT_INDEX",
        desc=(
    ...
    parameter(
        ...
        "CAT_INDEX",
        desc=(
            r"an integer array of size \mpiarg{len}, indicating category "
            r"indices"
        ),
        direction="out",
        length="len",
...
\begin{mpi-binding}
    function_name("MPI_T_category_changed")
    parameter(
        "update_number",
        "UPDATE_NUMBER",
        desc=(
