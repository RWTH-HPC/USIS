...
\begin{funcdef}{MPI\_GREQUEST\_START}{(\mbox{query\_fn}, \mbox{free\_fn}, \mbox{cancel\_fn}, \mbox{extra\_state}, \mbox{request})}
...
\end{funcdef}
\mpicallbackindex{MPI\_Grequest\_query\_function}%
\mpicallbackindex{MPI\_Grequest\_free\_function}%
\mpicallbackindex{MPI\_Grequest\_cancel\_function}%
\mpibindmain{MPI\_Grequest\_start}{(\gb{}MPI\_Grequest\_query\_function~*query\_fn, MPI\_Grequest\_free\_function~*free\_fn, MPI\_Grequest\_cancel\_function~*cancel\_fn, void~*extra\_state, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Grequest\_start}{(query\_fn, free\_fn, cancel\_fn, extra\_state, request, ierror) \fargs PROCEDURE(MPI\_Grequest\_query\_function)\ ::\ \mbox{query\_fn}\fnarg{}PROCEDURE(MPI\_Grequest\_free\_function)\ ::\ \mbox{free\_fn}\fnarg{}PROCEDURE(MPI\_Grequest\_cancel\_function)\ ::\ \mbox{cancel\_fn}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN)\ ::\ \mbox{extra\_state}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpicallbackindex{GREQUEST\_QUERY\_FUNCTION}%
\mpicallbackindex{GREQUEST\_FREE\_FUNCTION}%
\mpicallbackindex{GREQUEST\_CANCEL\_FUNCTION}%
\mpifbindmain{MPI\_GREQUEST\_START}{(QUERY\_FN, FREE\_FN, CANCEL\_FN, EXTRA\_STATE, REQUEST, IERROR) \fargs EXTERNAL \mbox{QUERY\_FN}, \mbox{FREE\_FN}, \mbox{CANCEL\_FN}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND) \mbox{EXTRA\_STATE}\fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\mpitypedefbindmain{MPI\_Grequest\_query\_function}{(\gb{}void~*extra\_state, MPI\_Status~*status)}
...
\mpifsubbindmain{GREQUEST\_QUERY\_FUNCTION}{(EXTRA\_STATE, STATUS, IERROR) \fargs INTEGER(KIND=MPI\_ADDRESS\_KIND) \mbox{EXTRA\_STATE}\fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}}
...
\mpitypedefbindmain{MPI\_Grequest\_free\_function}{(\gb{}void~*extra\_state)}
...
\mpifsubbindmain{GREQUEST\_FREE\_FUNCTION}{(EXTRA\_STATE, IERROR) \fargs INTEGER(KIND=MPI\_ADDRESS\_KIND) \mbox{EXTRA\_STATE}\fnfinalarg{}INTEGER \mbox{IERROR}}
...
\mpitypedefbindmain{MPI\_Grequest\_cancel\_function}{(\gb{}void~*extra\_state, int~complete)}
...
\mpifsubbindmain{GREQUEST\_CANCEL\_FUNCTION}{(EXTRA\_STATE, COMPLETE, IERROR) \fargs INTEGER(KIND=MPI\_ADDRESS\_KIND) \mbox{EXTRA\_STATE}\fnarg{}LOGICAL \mbox{COMPLETE}\fnfinalarg{}INTEGER \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}%
\begin{funcdef}{MPI\_GREQUEST\_COMPLETE}{(\mbox{request})}
\funcarg{\INOUT}{request}{generalized request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Grequest\_complete}{(\gb{}MPI\_Request~request)}
\mpifnewbindmain{MPI\_Grequest\_complete}{(request, ierror) \fargs TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_GREQUEST\_COMPLETE}{(REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_SET\_ELEMENTS}{(\mbox{status}, \mbox{datatype}, \mbox{count})}
...
\end{funcdef}
\mpibindmain{MPI\_Status\_set\_elements}{(\gb{}MPI\_Status~*status, MPI\_Datatype~datatype, int~count)}
\MPIbindindex{MPI\_Status\_set\_elements\_c}
\mpibindmain{MPI\_Status\_set\_elements\_c}{(\gb{}MPI\_Status~*status, MPI\_Datatype~datatype, MPI\_Count~count)}
\mpifnewbindmain{MPI\_Status\_set\_elements}{(status, datatype, count, ierror) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Status\_set\_elements}{(status, datatype, count, ierror) !(\_c) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_SET\_ELEMENTS}{(STATUS, DATATYPE, COUNT, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{DATATYPE}, \mbox{COUNT}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_SET\_CANCELLED}{(\mbox{status}, \mbox{flag})}
\funcarg{\INOUT}{status}{status with which to associate cancel flag (status)}
\funcarg{\IN}{flag}{if true, indicates request was cancelled (logical)}
\end{funcdef}
\mpibindmain{MPI\_Status\_set\_cancelled}{(\gb{}MPI\_Status~*status, int~flag)}
\mpifnewbindmain{MPI\_Status\_set\_cancelled}{(status, flag, ierror) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}LOGICAL, INTENT(IN)\ ::\ \mbox{flag}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_SET\_CANCELLED}{(STATUS, FLAG, IERROR) \fargs INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
...
\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_SET\_SOURCE}{(\mbox{status}, \mbox{source})}
\funcarg{\INOUT}{status}{status with which to associate source rank (status)}
\funcarg{\IN}{source}{rank to set in the \mpiconst{MPI\_SOURCE} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_set\_source}{(\gb{}MPI\_Status~*status, int~source)}
\mpifnewbindmain{MPI\_Status\_set\_source}{(status, source, ierror) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{source}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_SET\_SOURCE}{(STATUS, SOURCE, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{SOURCE}, \mbox{IERROR}}

Set the \mpiconst{MPI\_SOURCE} field in the \mpiarg{status} object to the provided \mpiarg{source} argument.

\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_SET\_TAG}{(\mbox{status}, \mbox{tag})}
\funcarg{\INOUT}{status}{status with which to associate tag (status)}
\funcarg{\IN}{tag}{tag to set in the \mpiconst{MPI\_TAG} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_set\_tag}{(\gb{}MPI\_Status~*status, int~tag)}
\mpifnewbindmain{MPI\_Status\_set\_tag}{(status, tag, ierror) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{tag}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_SET\_TAG}{(STATUS, TAG, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{TAG}, \mbox{IERROR}}

Set the \mpiconst{MPI\_TAG} field in the \mpiarg{status} object to the provided \mpiarg{tag} argument.

\cdeclindex{MPI\_Status}%
\begin{funcdef}{MPI\_STATUS\_SET\_ERROR}{(\mbox{status}, \mbox{err})}
\funcarg{\INOUT}{status}{status with which to associate error (status)}
\funcarg{\IN}{err}{error to set in the \mpiconst{MPI\_ERROR} field (integer)}
\end{funcdef}
\mpibindmain{MPI\_Status\_set\_error}{(\gb{}MPI\_Status~*status, int~err)}
\mpifnewbindmain{MPI\_Status\_set\_error}{(status, err, ierror) \fargs TYPE(MPI\_Status), INTENT(INOUT)\ ::\ \mbox{status}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{err}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_STATUS\_SET\_ERROR}{(STATUS, ERR, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{STATUS(MPI\_STATUS\_SIZE)}, \mbox{ERR}, \mbox{IERROR}}
