...
\begin{mpi-binding}
    function_name("MPI_Get_version")
    parameter("version", "VERSION", direction="out", desc=r"version number")
    parameter(
        "subversion", "VERSION", direction="out", desc=r"subversion number"
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Get_library_version")
    parameter(
        "version",
        "STRING",
        length="MPI_MAX_LIBRARY_VERSION_STRING",
        direction="OUT",
        desc=r"version number",
    )
    parameter(
        "resultlen",
        "STRING_LENGTH",
        direction="out",
        desc=(
            r"Length (in printable characters) of the result returned in "
            r"\mpiarg{version}"
        ),
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Get_processor_name")
    parameter(
        "name",
        "STRING",
        length="MPI_MAX_PROCESSOR_NAME",
        direction="OUT",
        desc=r"A unique specifier for the actual (as opposed to virtual) node.",
        suppress="lis_paren",
    )
    parameter(
        "resultlen",
...
\begin{mpi-binding}
  function_name("MPI_Get_hw_resource_info")
  parameter("hw_info", "INFO", desc=r"info object created", direction="OUT")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter(
        "size", "ALLOC_MEM_NUM_BYTES", desc=r"size of memory segment in bytes"
    )
    parameter("info", "INFO")
    parameter(
        "baseptr",
        "C_BUFFER",
        direction="out",
        desc=r"pointer to beginning of memory segment allocated",
        suppress="lis_paren",
    )
    
    f90_overload(
        r"\>INTERFACE MPI\_ALLOC\_MEM \\ "
        r"\>\>SUBROUTINE MPI\_ALLOC\_MEM(SIZE, INFO, BASEPTR, IERROR) \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: INFO, IERROR \\ "
        r"\>\>\>INTEGER(KIND=MPI\_ADDRESS\_KIND) :: SIZE, BASEPTR \\ "
        r"\>\>END SUBROUTINE \\ "
        r"\>\>SUBROUTINE MPI\_ALLOC\_MEM\_CPTR(SIZE, INFO, BASEPTR, IERROR) \\ "
...
%%ENDHEADER
\begin{mpi-binding}
    f90_overload_render("mpi_alloc_mem")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Free_mem")
    parameter(
        "base",
        "BUFFER",
        asynchronous=True,
        desc=(
            r"initial address of memory segment allocated by "
            r"\mpifunc{MPI_ALLOC_MEM}"
        ),
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Comm_create_errhandler")
    parameter(
        "comm_errhandler_fn",
        "FUNCTION",
        func_type="MPI_Comm_errhandler_function",
        desc=r"user defined error handling procedure",
    )
    parameter("errhandler", "ERRHANDLER", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name("MPI_Comm_errhandler_function", "COMM_ERRHANDLER_FUNCTION")
    
    parameter("comm", "COMMUNICATOR", direction="in", pointer=True)
    parameter("error_code", "ERROR_CODE", direction="in", pointer=True)
...
\begin{mpi-binding}
    render("mpi_comm_errhandler_function", "f08")
\end{mpi-binding}
...
\begin{mpi-binding}
    render("mpi_comm_errhandler_function", "f90")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Comm_set_errhandler")
    parameter("comm", "COMMUNICATOR", direction="lis:inout,param:in")
    parameter(
        "errhandler", "ERRHANDLER", desc=r"new error handler for communicator"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Errhandler}%
\begin{mpi-binding}
    function_name("MPI_Comm_get_errhandler")
    parameter("comm", "COMMUNICATOR")
    parameter(
        "errhandler",
        "ERRHANDLER",
        direction="out",
        desc=r"error handler currently associated with communicator",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Errhandler}%
\begin{mpi-binding}
    function_name("MPI_Win_create_errhandler")
    parameter(
        "win_errhandler_fn",
        "FUNCTION",
...
\begin{mpi-binding}
    ...
    function_name("MPI_Win_errhandler_function", "WIN_ERRHANDLER_FUNCTION")
    
    parameter("win", "WINDOW", direction="in", pointer=True)
    parameter("error_code", "ERROR_CODE", direction="in", pointer=True)
    parameter("varargs", "VARARGS")
...
\begin{mpi-binding}
    render("mpi_win_errhandler_function", "f08")
\end{mpi-binding}
...
\begin{mpi-binding}
    render("mpi_win_errhandler_function", "f90")
\end{mpi-binding}

\cdeclindex{MPI\_Errhandler}%
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_set_errhandler")
    parameter("win", "WINDOW", direction="lis:inout,param:in")
    parameter("errhandler", "ERRHANDLER", desc=r"new error handler for window")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_get_errhandler")
    parameter("win", "WINDOW")
    parameter(
        "errhandler",
        "ERRHANDLER",
        direction="out",
        desc=r"error handler currently associated with window",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Errhandler}%
\begin{mpi-binding}
    function_name("MPI_File_create_errhandler")
    parameter(
        "file_errhandler_fn",
        "FUNCTION",
        func_type="MPI_File_errhandler_function",
        desc=r"user defined error handling procedure",
    )
    parameter("errhandler", "ERRHANDLER", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name("MPI_File_errhandler_function", "FILE_ERRHANDLER_FUNCTION")
    
    parameter("file", "FILE", direction="in", pointer=True)
    parameter("error_code", "ERROR_CODE", direction="in", pointer=True)
    parameter("varargs", "VARARGS")
...
\begin{mpi-binding}
    render("mpi_file_errhandler_function", "f08")
\end{mpi-binding}
...
\begin{mpi-binding}
    render("mpi_file_errhandler_function", "f90")
\end{mpi-binding}

\cdeclindex{MPI\_Errhandler}%
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_set_errhandler")
    parameter("file", "FILE", direction="lis:inout,param:in")
    parameter("errhandler", "ERRHANDLER", desc=r"new error handler for file")
\end{mpi-binding}
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_get_errhandler")
    parameter("file", "FILE")
    parameter(
        "errhandler",
        "ERRHANDLER",
        direction="out",
        desc=r"error handler currently associated with file",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Errhandler}%
\begin{mpi-binding}
    function_name("MPI_Session_create_errhandler")
    parameter(
        "session_errhandler_fn",
        "FUNCTION",
        func_type="MPI_Session_errhandler_function",
        desc=r"user defined error handling procedure",
        suppress="tilda",
    )
    parameter("errhandler", "ERRHANDLER", direction="out")
...
\begin{mpi-binding}
    ...
    function_name("MPI_Session_errhandler_function", "SESSION_ERRHANDLER_FUNCTION")

    parameter("session", "SESSION", direction="in", pointer=True)
    parameter("error_code", "ERROR_CODE", direction="in", pointer=True)
    parameter("varargs", "VARARGS")
...
\begin{mpi-binding}
    render("mpi_session_errhandler_function", "f08")
\end{mpi-binding}
...
\begin{mpi-binding}
    render("mpi_session_errhandler_function", "f90")
\end{mpi-binding}

\cdeclindex{MPI\_Errhandler}%
\cdeclindex{MPI\_Session}%
\begin{mpi-binding}
    function_name("MPI_Session_set_errhandler")
    parameter("session", "SESSION", direction="lis:inout,param:in", desc = "session")
    parameter("errhandler", "ERRHANDLER", desc=r"new error handler for session")
\end{mpi-binding}
...
\cdeclindex{MPI\_Session}%
\begin{mpi-binding}
    function_name("MPI_Session_get_errhandler")
    parameter("session", "SESSION", desc = "session")
    parameter(
        "errhandler",
        "ERRHANDLER",
        direction="out",
        desc=r"error handler currently associated with session",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Errhandler}%
\begin{mpi-binding}
    function_name("MPI_Errhandler_free")
    parameter("errhandler", "ERRHANDLER", direction="inout")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Error_string")
    parameter(
        "errorcode",
        "ERROR_CODE",
        desc=r"Error code returned by an \MPI/ routine",
        suppress="lis_paren",
    )
    parameter(
        "string",
        ...
        desc=r"Text that corresponds to the \mpiarg{errorcode}",
        suppress="lis_paren",
    )
    parameter(
        "resultlen",
        "STRING_LENGTH",
        direction="out",
        desc=r"Length (in printable characters) of the result returned in \mpiarg{string}",
        suppress="lis_paren",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter(
        ...
        "ERROR_CLASS",
        direction="out",
        desc=r"Error class associated with \mpiarg{errorcode}",
        suppress="lis_paren",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Add_error_class")
    parameter(
        "errorclass",
        "ERROR_CLASS",
        direction="out",
        desc=r"value for the new error class",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Remove_error_class")
    parameter(
        "errorclass",
        "ERROR_CLASS",
        direction="in",
        desc=r"value for the error class to remove",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Add_error_code")
    parameter("errorclass", "ERROR_CLASS")
    parameter(
        "errorcode",
        "ERROR_CODE",
        direction="out",
        desc=r"new error code to be associated with \mpiarg{errorclass}",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Remove_error_code")
    parameter(
        "errorcode",
        "ERROR_CODE",
        direction="in",
        desc=r"error code to be removed",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Add_error_string")
    parameter("errorcode", "ERROR_CODE", desc=r"error code or class")
    parameter(
        "string",
        "STRING",
        constant=True,
        desc=r"text corresponding to \mpiarg{errorcode}",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Remove_error_string")
    parameter("errorcode", "ERROR_CODE", desc=r"error code or class")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Comm_call_errhandler")
    parameter("comm", "COMMUNICATOR", desc=r"communicator with error handler")
    parameter("errorcode", "ERROR_CODE")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Win_call_errhandler")
    parameter("win", "WINDOW", desc=r"window with error handler")
    parameter("errorcode", "ERROR_CODE")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_File_call_errhandler")
    parameter("fh", "FILE", desc=r"file with error handler")
    parameter("errorcode", "ERROR_CODE")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Session_call_errhandler")
    parameter("session", "SESSION", desc=r"session with error handler")
    parameter("errorcode", "ERROR_CODE")
\end{mpi-binding}
