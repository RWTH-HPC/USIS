...
\begin{mpi-binding}
    function_name("MPI_Win_create")
    
    parameter(
        "base",
        "BUFFER",
        desc=r"initial address of window",
        asynchronous=True,
        suppress="f08_intent",
    )
    parameter("size", "WINDOW_SIZE", desc=r"size of window in bytes")
    parameter(
        "disp_unit",
        "POLYRMA_DISPLACEMENT",
        desc=r"local unit size for displacements, in bytes",
    )
    parameter("info", "INFO")
    parameter("comm", "COMMUNICATOR", desc=r"intra-communicator")
    parameter("win", "WINDOW", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Win_allocate")
    ...
    parameter("comm", "COMMUNICATOR", desc=r"intra-communicator")
    parameter(
        "baseptr", "C_BUFFER", desc=r"initial address of window", direction="out"
    )
    parameter(
    ...
    f90_overload(
        r"\>INTERFACE MPI\_WIN\_ALLOCATE \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_ALLOCATE(SIZE, DISP\_UNIT, INFO, COMM, BASEPTR, \& \\ "
        r"\>\>\>\>WIN, IERROR) \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: DISP\_UNIT, INFO, COMM, WIN, IERROR \\ "
        r"\>\>\>INTEGER(KIND=MPI\_ADDRESS\_KIND) :: SIZE, BASEPTR \\ "
        r"\>\>END SUBROUTINE \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_ALLOCATE\_CPTR(SIZE, DISP\_UNIT, INFO, COMM, BASEPTR, \& \\ "
        r"\>\>\>\>WIN, IERROR) \\ "
        r"\>\>\>USE, INTRINSIC :: ISO\_C\_BINDING, ONLY : C\_PTR \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: DISP\_UNIT, INFO, COMM, WIN, IERROR \\ "
        r"\>\>\>INTEGER(KIND=MPI\_ADDRESS\_KIND) :: SIZE \\ "
        r"\>\>\>TYPE(C\_PTR) :: BASEPTR \\ "
        r"\>\>END SUBROUTINE \\ "
        r"\>END INTERFACE"
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    f90_overload_render("mpi_win_allocate")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Win_allocate_shared")
    
    parameter("size", "WINDOW_SIZE", desc=r"size of local window in bytes")
    parameter(
        "disp_unit",
        "POLYRMA_DISPLACEMENT",
        desc=r"local unit size for displacements, in bytes",
    ...
    parameter(
        "baseptr",
        "C_BUFFER",
        desc=r"address of local allocated window segment",
        direction="out",
    )
    parameter(
        "win",
    ...
    f90_overload(
        r"\>INTERFACE MPI\_WIN\_ALLOCATE\_SHARED \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_ALLOCATE\_SHARED(SIZE, DISP\_UNIT, INFO, COMM, \& \\ "
        r"\>\>\>\>BASEPTR, WIN, IERROR) \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: DISP\_UNIT, INFO, COMM, WIN, IERROR \\ "
        r"\>\>\>INTEGER(KIND=MPI\_ADDRESS\_KIND) :: SIZE, BASEPTR \\ "
        r"\>\>END SUBROUTINE \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_ALLOCATE\_SHARED\_CPTR(SIZE, DISP\_UNIT, INFO, COMM, \& \\ "
        r"\>\>\>\>BASEPTR, WIN, IERROR) \\ "
        r"\>\>\>USE, INTRINSIC :: ISO\_C\_BINDING, ONLY : C\_PTR \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: DISP\_UNIT, INFO, COMM, WIN, IERROR \\ "
...
\begin{mpi-binding}
    f90_overload_render("mpi_win_allocate_shared")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Win_shared_query")
    
    parameter("win", "WINDOW", desc=r"shared memory window")
    parameter(
        "rank",
        "RANK_NNI",
        desc=r"rank in the group of window win or \mpiconst{MPI_PROC_NULL}",
    )
    parameter(
        "size",
        "WINDOW_SIZE",
        desc=r"size of the window segment",
        direction="out",
    )
    parameter(
        "disp_unit",
    ...
    parameter(
        "baseptr",
        "C_BUFFER",
        desc=r"address for load/store access to window segment",
        direction="out",
    )
    
    f90_overload(
        r"\>INTERFACE MPI\_WIN\_SHARED\_QUERY \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_SHARED\_QUERY(WIN, RANK, SIZE, DISP\_UNIT, \&\\ "
        r"\>\>\>\>BASEPTR, IERROR) \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: WIN, RANK, DISP\_UNIT, IERROR \\ "
        r"\>\>\>INTEGER(KIND=MPI\_ADDRESS\_KIND) :: SIZE, BASEPTR \\ "
        r"\>\>END SUBROUTINE \\ "
        r"\>\>SUBROUTINE MPI\_WIN\_SHARED\_QUERY\_CPTR(WIN, RANK, SIZE, DISP\_UNIT, \&\\ "
        r"\>\>\>\>BASEPTR, IERROR) \\ "
        r"\>\>\>USE, INTRINSIC :: ISO\_C\_BINDING, ONLY : C\_PTR \\ "
        r"\>\>\>IMPORT :: MPI\_ADDRESS\_KIND \\ "
        r"\>\>\>INTEGER :: WIN, RANK, DISP\_UNIT, IERROR \\ "
...
\begin{mpi-binding}
    f90_overload_render("mpi_win_shared_query")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Win_create_dynamic")
...
\begin{mpi-binding}
    function_name("MPI_Win_attach")
    
    parameter("win", "WINDOW")
    parameter(
        "base",
        "BUFFER",
        desc=r"initial address of memory to be attached",
        asynchronous=True,
        suppress="f08_intent",
    )
    parameter(
        "size",
        "WIN_ATTACH_SIZE",
        desc=r"size of memory to be attached in bytes",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Win_detach")
    
    parameter("win", "WINDOW")
    parameter(
        "base",
        "BUFFER",
        desc=r"initial address of memory to be detached",
        constant=True,
        asynchronous=True,
        suppress="f08_intent",
    )
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_free")
    
    parameter("win", "WINDOW", direction="inout")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_get_group")
    parameter("win", "WINDOW")
    parameter(
        "group",
        "GROUP",
        desc=r"group of \mpi/ processes that share access to the window",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_set_info")
    
    parameter("win", "WINDOW", direction="lis:inout,param:in")
    parameter("info", "INFO")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_get_info")
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Put")
    
    parameter(
        "origin_addr",
        "BUFFER",
        desc=r"initial address of origin buffer",
        constant=True,
        asynchronous=True,
    )
    parameter(
        ...
        desc=r"number of entries in origin buffer",
    )
    parameter(
        "origin_datatype",
        "DATATYPE",
        desc=r"datatype of each entry in origin buffer",
    )
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
        "RMA_DISPLACEMENT_NNI",
        desc=r"displacement from start of window to target buffer",
    )
    parameter(
        "target_count",
        "POLYXFER_NUM_ELEM_NNI",
        desc=r"number of entries in target buffer",
    )
    parameter(
        "target_datatype",
        "DATATYPE",
        desc=r"datatype of each entry in target buffer",
    )
    parameter("win", "WINDOW", desc=r"window used for communication")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter(
        "origin_count",
        "POLYXFER_NUM_ELEM_NNI",
        desc=r"number of entries in buffer",
    )
    parameter("origin_datatype", "DATATYPE", desc=r"datatype of each entry")
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
        "RMA_DISPLACEMENT_NNI",
        desc=r"displacement from start of window to beginning of target buffer",
    )
    parameter(
        "target_count",
        "POLYXFER_NUM_ELEM_NNI",
    ...
    parameter("op", "OPERATION", desc=r"accumulate operator")
    parameter("win", "WINDOW")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Get_accumulate")
    ...
    parameter(
        "result_addr",
        "BUFFER",
        desc=r"initial address of result buffer",
        direction="out",
        asynchronous=True,
    )
    parameter(
        "result_count",
        "POLYXFER_NUM_ELEM_NNI",
        desc=r"number of entries in result buffer",
    )
    parameter(
        "result_datatype",
        "DATATYPE",
        desc=r"datatype of each entry in result buffer",
    )
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Fetch_and_op")
    ...
    parameter(
        "datatype",
        "DATATYPE",
        desc=r"datatype of the entry in origin, result, and target buffers",
    )
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Compare_and_swap")
    ...
    parameter(
        "compare_addr",
        "BUFFER",
        desc=r"initial address of compare buffer",
        constant=True,
        asynchronous=True,
    )
    parameter(
    ...
    parameter(
        "datatype", "DATATYPE", desc=r"datatype of the element in all buffers"
    )
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
...
\begin{mpi-binding}
    ...
    parameter("win", "WINDOW", desc=r"window used for communication")
    parameter("request", "REQUEST", direction="out", desc=r"\RMA/ request")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter("win", "WINDOW", desc=r"window used for communication")
    parameter("request", "REQUEST", desc=r"\RMA/ request", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Rget_accumulate")
    ...
    parameter(
        "result_datatype",
        "DATATYPE",
        desc=r"datatype of entries in result buffer",
    )
    parameter("target_rank", "RANK_NNI", desc=r"rank of target")
    parameter(
        "target_disp",
...
\begin{figure}
\centerline{\includegraphics[width=6.0in]{figures/window1}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=3.0in]{figures/sync15}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=4.5in]{figures/sync23}}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_start")
    
    parameter("group", "GROUP", desc=r"group of target processes")
    parameter("assert", "ASSERT")
    parameter("win", "WINDOW")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_complete")
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_post")
    
    parameter("group", "GROUP", desc=r"group of origin processes")
    parameter("assert", "ASSERT")
    parameter("win", "WINDOW")
\end{mpi-binding}
...
functions.
\begin{figure}
\centerline{\includegraphics[width=4.5in]{figures/2party}}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_test")
    
    parameter("win", "WINDOW")
    parameter("flag", "LOGICAL", desc=r"success flag", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_lock")
    
    parameter(
        "lock_type",
        "LOCK_TYPE",
        desc=r"either \mpiconst{MPI_LOCK_EXCLUSIVE} or \mpiconst{MPI_LOCK_SHARED}",
    )
    parameter("rank", "RANK_NNI", desc=r"rank of target \MPI/ process in the group of the window \mpiarg{win}")
    parameter("assert", "ASSERT")
    parameter("win", "WINDOW")
\end{mpi-binding}
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_lock_all")
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_unlock_all")
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_flush_all")
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_flush_local")
...
\cdeclindex{MPI\_Win}%
\begin{mpi-binding}
    function_name("MPI_Win_flush_local_all")
...
\begin{figure}[t]
\centerline{\includegraphics[width=3.0in]{figures/symmetric}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=2.5in]{figures/deadlck1}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=2.5in]{figures/deadlck2}}
