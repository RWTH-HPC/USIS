...
\begin{figure}
  \centerline{\includegraphics[scale=0.9]{figures/coll-fig1-22}}
...
\begin{figure}[htpb]
  \centerline{\includegraphics[width=4.0in]{figures/collective-allgather}}
...
\begin{figure}[htpb]
  \centerline{\includegraphics[width=4.0in]{figures/collective-reduce_scatter}}
...
\begin{funcdef}{MPI\_BARRIER}{(\mbox{comm})}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Barrier}{(\gb{}MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Barrier}{(comm, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BARRIER}{(COMM, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_BCAST}{(\mbox{buffer}, \mbox{count}, \mbox{datatype}, \mbox{root}, \mbox{comm})}
\funcarg{\INOUT}{buffer}{starting address of buffer (choice)}
\funcarg{\IN}{count}{number of entries in buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of buffer (handle)}
\funcarg{\IN}{root}{rank of the root (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Bcast}{(\gb{}void~*buffer, int~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Bcast\_c}
\mpibindmain{MPI\_Bcast\_c}{(\gb{}void~*buffer, MPI\_Count~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Bcast}{(buffer, count, datatype, root, comm, ierror) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Bcast}{(buffer, count, datatype, root, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..)\ ::\ \mbox{buffer}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BCAST}{(BUFFER, COUNT, DATATYPE, ROOT, COMM, IERROR) \fargs <type> \mbox{BUFFER(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_GATHER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
\funcarg{\IN}{recvcount}{number of elements for any single receive (nonnegative integer, significant only at root)}
\funcarg{\IN}{recvtype}{datatype of recv buffer elements (handle, significant only at root)}
\funcarg{\IN}{root}{rank of receiving \MPI/ process (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Gather}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Gather\_c}
\mpibindmain{MPI\_Gather\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Gather}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_GATHER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_GATHERV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{root}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) containing the number of elements that are received from each \MPI/ process (significant only at root)}
\funcarg{\IN}{displs}{integer array (of length group size). Entry \mpicode{i} specifies the displacement relative to \mpiarg{recvbuf} at which to place the incoming data from \MPI/ process \mpicode{i} (significant only at root)}
\funcarg{\IN}{recvtype}{datatype of recv buffer elements (handle, significant only at root)}
\funcarg{\IN}{root}{rank of receiving \MPI/ process (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Gatherv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Gatherv\_c}
\mpibindmain{MPI\_Gatherv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Gatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcounts(*)}, \mbox{displs(*)}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Gatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN)\ ::\ \mbox{displs(*)}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_GATHERV}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, ROOT, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{figure}
  \centerline{\includegraphics[width=3.50in]{figures/mycoll-fig2}}
...
\begin{figure}
  \centerline{\includegraphics[width=3.50in]{figures/mycoll-fig3}}
...
\begin{figure}
  \centerline{\includegraphics[width=4.00in]{figures/mycoll-fig4}}
...
\begin{figure}
  \centerline{\includegraphics[width=4.00in]{figures/mycoll-fig5}}
...
\begin{figure}
  \centerline{\includegraphics[width=4.00in]{figures/mycoll-fig6}}
...
\begin{funcdef}{MPI\_SCATTER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer, significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{root}{rank of sending \MPI/ process (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scatter}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Scatter\_c}
\mpibindmain{MPI\_Scatter\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Scatter}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Scatter}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SCATTER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_SCATTERV}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{displs}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each rank (significant only at root)}
\funcarg{\IN}{displs}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data to \MPI/ process \mpicode{i} (significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements in receive buffer (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
...
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scatterv}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~displs[], MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Scatterv\_c}
\mpibindmain{MPI\_Scatterv\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Scatterv}{(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcounts(*)}, \mbox{displs(*)}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_SCATTERV}{(SENDBUF, SENDCOUNTS, DISPLS, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{figure}
  \centerline{\includegraphics[width=3.50in]{figures/mycoll-fig7}}
...
\begin{figure}
  \centerline{\includegraphics[width=3.50in]{figures/mycoll-fig8}}
...
\begin{figure}
  \centerline{\includegraphics[width=4.00in]{figures/mycoll-fig9}}
...
\begin{funcdef}{MPI\_ALLGATHER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements received from any \MPI/ process (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allgather}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Allgather\_c}
\mpibindmain{MPI\_Allgather\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Allgather}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_ALLGATHER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ALLGATHERV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) containing the number of elements that are received from each \MPI/ process}
\funcarg{\IN}{displs}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{recvbuf}) at which to place the incoming data from \MPI/ process \mpicode{i}}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allgatherv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Allgatherv\_c}
\mpibindmain{MPI\_Allgatherv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Allgatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Allgatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN)\ ::\ \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLGATHERV}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ALLTOALL}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements received from any \MPI/ process (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoall}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Alltoall\_c}
\mpibindmain{MPI\_Alltoall\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Alltoall}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoall}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALL}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ALLTOALLV}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtype}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each rank}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j}}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) specifying the number of elements that can be received from each rank}
\funcarg{\IN}{rdispls}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{recvbuf}) at which to place the incoming data from \MPI/ process \mpicode{i}}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoallv}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Alltoallv\_c}
\mpibindmain{MPI\_Alltoallv\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Alltoallv}{(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoallv}{(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcounts(*)}, \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN)\ ::\ \mbox{sdispls(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALLV}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ALLTOALLW}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtypes}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtypes}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each rank}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement in bytes (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j} (array of integers)}
\funcarg{\IN}{sendtypes}{array of datatypes (of length group size). Entry \mpicode{j} specifies the type of data to send to \MPI/ process \mpicode{j} (array of handles)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) specifying the number of elements that can be received from each rank}
\funcarg{\IN}{rdispls}{integer array (of length group size). Entry \mpicode{i} specifies the displacement in bytes (relative to \mpiarg{recvbuf}) at which to place the incoming data from \MPI/ process \mpicode{i} (array of integers)}
\funcarg{\IN}{recvtypes}{array of datatypes (of length group size). Entry \mpicode{i} specifies the type of data received from \MPI/ process \mpicode{i} (array of handles)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoallw}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm)}
\MPIbindindex{MPI\_Alltoallw\_c}
\mpibindmain{MPI\_Alltoallw\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Alltoallw}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoallw}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcounts(*)}, \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN)\ ::\ \mbox{sdispls(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALLW}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPES, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPES, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPES(*)}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPES(*)}, \mbox{COMM}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{root}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send buffer (handle)}
\funcarg{\IN}{op}{reduce operation (handle)}
\funcarg{\IN}{root}{rank of the root (integer)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Reduce\_c}
\mpibindmain{MPI\_Reduce\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Reduce}{(sendbuf, recvbuf, count, datatype, op, root, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce}{(sendbuf, recvbuf, count, datatype, op, root, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, ROOT, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{ROOT}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_TYPE\_GET\_VALUE\_INDEX}{(\mbox{value\_type}, \mbox{index\_type}, \mbox{pair\_type})}
\funcarg{\IN}{value\_type}{datatype of the value in pair (handle)}
\funcarg{\IN}{index\_type}{datatype of the index in pair (handle)}
\funcarg{\OUT}{pair\_type}{datatype of the value-index pair (handle)}
\end{funcdef}
\mpibindmain{MPI\_Type\_get\_value\_index}{(\gb{}MPI\_Datatype~value\_type, MPI\_Datatype~index\_type, MPI\_Datatype~*pair\_type)}
\mpifnewbindmain{MPI\_Type\_get\_value\_index}{(value\_type, index\_type, pair\_type, ierror) \fargs TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{value\_type}, \mbox{index\_type}\fnarg{}TYPE(MPI\_Datatype), INTENT(OUT)\ ::\ \mbox{pair\_type}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_TYPE\_GET\_VALUE\_INDEX}{(VALUE\_TYPE, INDEX\_TYPE, PAIR\_TYPE, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{VALUE\_TYPE}, \mbox{INDEX\_TYPE}, \mbox{PAIR\_TYPE}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_OP\_CREATE}{(\mbox{user\_fn}, \mbox{commute}, \mbox{op})}
\funcarg{\IN}{user\_fn}{user defined function (function)}
\funcarg{\IN}{commute}{\mpicode{true} if commutative; \mpicode{false} otherwise.}
\funcarg{\OUT}{op}{operation (handle)}
\end{funcdef}
\mpicallbackindex{MPI\_User\_function}%
\mpibindmain{MPI\_Op\_create}{(\gb{}MPI\_User\_function~*user\_fn, int~commute, MPI\_Op~*op)}
\mpicallbackindex{MPI\_User\_function\_c}%
\MPIbindindex{MPI\_Op\_create\_c}
\mpibindmain{MPI\_Op\_create\_c}{(\gb{}MPI\_User\_function\_c~*user\_fn, int~commute, MPI\_Op~*op)}
\mpifnewbindmain{MPI\_Op\_create}{(user\_fn, commute, op, ierror) \fargs PROCEDURE(MPI\_User\_function)\ ::\ \mbox{user\_fn}\fnarg{}LOGICAL, INTENT(IN)\ ::\ \mbox{commute}\fnarg{}TYPE(MPI\_Op), INTENT(OUT)\ ::\ \mbox{op}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Op\_create\_c}{(user\_fn, commute, op, ierror) !(\_c) \fargs PROCEDURE(MPI\_User\_function\_c)\ ::\ \mbox{user\_fn}\fnarg{}LOGICAL, INTENT(IN)\ ::\ \mbox{commute}\fnarg{}TYPE(MPI\_Op), INTENT(OUT)\ ::\ \mbox{op}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpicallbackindex{USER\_FUNCTION}%
\mpifbindmain{MPI\_OP\_CREATE}{(USER\_FN, COMMUTE, OP, IERROR) \fargs EXTERNAL \mbox{USER\_FN}\fnarg{}LOGICAL \mbox{COMMUTE}\fnfinalarg{}INTEGER \mbox{OP}, \mbox{IERROR}}
...
\mpitypedefbindvoidmain{MPI\_User\_function}{(\gb{}void~*invec, void~*inoutvec, int~*len, MPI\_Datatype~*datatype)}
\mpitypedefbindvoidmain{MPI\_User\_function\_c}{(\gb{}void~*invec, void~*inoutvec, MPI\_Count~*len, MPI\_Datatype~*datatype)}
...
\mpifsubbindmain{USER\_FUNCTION}{(INVEC, INOUTVEC, LEN, DATATYPE) \fargs <type> \mbox{INVEC(LEN)}, \mbox{INOUTVEC(LEN)}\fnfinalarg{}INTEGER \mbox{LEN}, \mbox{DATATYPE}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_OP\_FREE}{(\mbox{op})}
\funcarg{\INOUT}{op}{operation (handle)}
\end{funcdef}
\mpibindmain{MPI\_Op\_free}{(\gb{}MPI\_Op~*op)}
\mpifnewbindmain{MPI\_Op\_free}{(op, ierror) \fargs TYPE(MPI\_Op), INTENT(INOUT)\ ::\ \mbox{op}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_OP\_FREE}{(OP, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{OP}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_ALLREDUCE}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
...
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allreduce}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Allreduce\_c}
\mpibindmain{MPI\_Allreduce\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Allreduce}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Allreduce}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLREDUCE}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_LOCAL}{(\mbox{inbuf}, \mbox{inoutbuf}, \mbox{count}, \mbox{datatype}, \mbox{op})}
\funcarg{\IN}{inbuf}{input buffer (choice)}
\funcarg{\INOUT}{inoutbuf}{combined input and output buffer (choice)}
\funcarg{\IN}{count}{number of elements in \mpiarg{inbuf} and \mpiarg{inoutbuf} buffers (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of \mpiarg{inbuf} and \mpiarg{inoutbuf} buffers (handle)}
\funcarg{\IN}{op}{operation (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_local}{(\gb{}const~void~*inbuf, void~*inoutbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op)}
\MPIbindindex{MPI\_Reduce\_local\_c}
\mpibindmain{MPI\_Reduce\_local\_c}{(\gb{}const~void~*inbuf, void~*inoutbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op)}
\mpifnewbindmain{MPI\_Reduce\_local}{(inbuf, inoutbuf, count, datatype, op, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{inbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{inoutbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_local}{(inbuf, inoutbuf, count, datatype, op, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{inbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{inoutbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_LOCAL}{(INBUF, INOUTBUF, COUNT, DATATYPE, OP, IERROR) \fargs <type> \mbox{INBUF(*)}, \mbox{INOUTBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_OP\_COMMUTATIVE}{(\mbox{op}, \mbox{commute})}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\OUT}{commute}{\mpicode{true} if \mpiarg{op} is commutative, \mpicode{false} otherwise (logical)}
\end{funcdef}
\mpibindmain{MPI\_Op\_commutative}{(\gb{}MPI\_Op~op, int~*commute)}
\mpifnewbindmain{MPI\_Op\_commutative}{(op, commute, ierror) \fargs TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{commute}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_OP\_COMMUTATIVE}{(OP, COMMUTE, IERROR) \fargs INTEGER \mbox{OP}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{COMMUTE}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_SCATTER\_BLOCK}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{datatype}, \mbox{op}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{element count per block (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send and receive buffers (handle)}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_scatter\_block}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Reduce\_scatter\_block\_c}
\mpibindmain{MPI\_Reduce\_scatter\_block\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Reduce\_scatter\_block}{(sendbuf, recvbuf, recvcount, datatype, op, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_scatter\_block}{(sendbuf, recvbuf, recvcount, datatype, op, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_SCATTER\_BLOCK}{(SENDBUF, RECVBUF, RECVCOUNT, DATATYPE, OP, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_SCATTER}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{datatype}, \mbox{op}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) specifying the number of elements of the result distributed to each \MPI/ process.}
\funcarg{\IN}{datatype}{datatype of elements of send and receive buffers (handle)}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_scatter}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~int~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Reduce\_scatter\_c}
\mpibindmain{MPI\_Reduce\_scatter\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~MPI\_Count~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Reduce\_scatter}{(sendbuf, recvbuf, recvcounts, datatype, op, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_scatter}{(sendbuf, recvbuf, recvcounts, datatype, op, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_SCATTER}{(SENDBUF, RECVBUF, RECVCOUNTS, DATATYPE, OP, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNTS(*)}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_SCAN}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scan}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Scan\_c}
\mpibindmain{MPI\_Scan\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Scan}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Scan}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SCAN}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_EXSCAN}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
...
\end{funcdef}
\mpibindmain{MPI\_Exscan}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\MPIbindindex{MPI\_Exscan\_c}
\mpibindmain{MPI\_Exscan\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm)}
\mpifnewbindmain{MPI\_Exscan}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Exscan}{(sendbuf, recvbuf, count, datatype, op, comm, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..)\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_EXSCAN}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IBARRIER}{(\mbox{comm}, \mbox{request})}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ibarrier}{(\gb{}MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ibarrier}{(comm, request, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IBARRIER}{(COMM, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IBCAST}{(\mbox{buffer}, \mbox{count}, \mbox{datatype}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\INOUT}{buffer}{starting address of buffer (choice)}
\funcarg{\IN}{count}{number of entries in buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ibcast}{(\gb{}void~*buffer, int~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ibcast\_c}
\mpibindmain{MPI\_Ibcast\_c}{(\gb{}void~*buffer, MPI\_Count~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ibcast}{(buffer, count, datatype, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IBCAST}{(BUFFER, COUNT, DATATYPE, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{BUFFER(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IGATHER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Igather}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Igather\_c}
\mpibindmain{MPI\_Igather\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Igather}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IGATHER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

This call starts a nonblocking variant of \mpifunc{MPI\_GATHER} (see
Section~\ref{sec:coll-gather}).

\begin{funcdef}{MPI\_IGATHERV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Igatherv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Igatherv\_c}
\mpibindmain{MPI\_Igatherv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Igatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IGATHERV}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ISCATTER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer, significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iscatter}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iscatter\_c}
\mpibindmain{MPI\_Iscatter\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iscatter}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Iscatter}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ISCATTER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

This call starts a nonblocking variant of \mpifunc{MPI\_SCATTER} (see
Section~\ref{sec:coll-scatter}).

\begin{funcdef}{MPI\_ISCATTERV}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{displs}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each \MPI/ process (significant only at root)}
\funcarg{\IN}{displs}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data to \MPI/ process \mpicode{i} (significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements in receive buffer (nonnegative integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iscatterv}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~displs[], MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iscatterv\_c}
\mpibindmain{MPI\_Iscatterv\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iscatterv}{(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_ISCATTERV}{(SENDBUF, SENDCOUNTS, DISPLS, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IALLGATHER}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iallgather}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iallgather\_c}
\mpibindmain{MPI\_Iallgather\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iallgather}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Iallgather}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IALLGATHER}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

This call starts a nonblocking variant of \mpifunc{MPI\_ALLGATHER}
(see Section~\ref{sec:coll-allcast}).


\begin{funcdef}{MPI\_IALLGATHERV}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iallgatherv}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iallgatherv\_c}
\mpibindmain{MPI\_Iallgatherv\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iallgatherv}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IALLGATHERV}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_IALLTOALL}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ialltoall}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ialltoall\_c}
\mpibindmain{MPI\_Ialltoall\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ialltoall}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Ialltoall}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IALLTOALL}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

This call starts a nonblocking variant of \mpifunc{MPI\_ALLTOALL} (see
Section~\ref{sec:coll-alltoall}).

\begin{funcdef}{MPI\_IALLTOALLV}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtype}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each \MPI/ process}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j}}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array (of length group size) specifying the number of elements that can be received from each \MPI/ process}
\funcarg{\IN}{rdispls}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{recvbuf}) at which to place the incoming data from \MPI/ process \mpicode{i}}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ialltoallv}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ialltoallv\_c}
\mpibindmain{MPI\_Ialltoallv\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ialltoallv}{(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IALLTOALLV}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}

This call starts a nonblocking variant of \mpifunc{MPI\_ALLTOALLV} (see
Section~\ref{sec:coll-alltoall}).


\begin{funcdef}{MPI\_IALLTOALLW}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtypes}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtypes}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{integer array (of length group size) specifying the number of elements to send to each \MPI/ process (array of nonnegative integers)}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement in bytes (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j} (array of integers)}
\funcarg{\IN}{sendtypes}{array of datatypes (of length group size). Entry \mpicode{j} specifies the type of data to send to \MPI/ process \mpicode{j} (array of handles)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{integer array (of length group size) specifying the number of elements that can be received from each \MPI/ process (array of nonnegative integers)}
\funcarg{\IN}{rdispls}{integer array (of length group size). Entry \mpicode{i} specifies the displacement in bytes (relative to \mpiarg{recvbuf}) at which to place the incoming data from \MPI/ process \mpicode{i} (array of integers)}
\funcarg{\IN}{recvtypes}{array of datatypes (of length group size). Entry \mpicode{i} specifies the type of data received from \MPI/ process \mpicode{i} (array of handles)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ialltoallw}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ialltoallw\_c}
\mpibindmain{MPI\_Ialltoallw\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ialltoallw}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Ialltoallw}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sdispls(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IALLTOALLW}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPES, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPES, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPES(*)}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPES(*)}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_IREDUCE}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{root}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ireduce}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ireduce\_c}
\mpibindmain{MPI\_Ireduce\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ireduce}{(sendbuf, recvbuf, count, datatype, op, root, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IREDUCE}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, ROOT, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{ROOT}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_IALLREDUCE}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iallreduce}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iallreduce\_c}
\mpibindmain{MPI\_Iallreduce\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iallreduce}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Iallreduce}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IALLREDUCE}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_IREDUCE\_SCATTER\_BLOCK}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{element count per block (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send and receive buffers (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ireduce\_scatter\_block}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ireduce\_scatter\_block\_c}
\mpibindmain{MPI\_Ireduce\_scatter\_block\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Ireduce\_scatter\_block}{(sendbuf, recvbuf, recvcount, datatype, op, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\mpifbindmain{MPI\_IREDUCE\_SCATTER\_BLOCK}{(SENDBUF, RECVBUF, RECVCOUNT, DATATYPE, OP, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_IREDUCE\_SCATTER}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array specifying the number of elements in result distributed to each \MPI/ process.}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Ireduce\_scatter}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~int~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Ireduce\_scatter\_c}
\mpibindmain{MPI\_Ireduce\_scatter\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~MPI\_Count~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
...
\mpifbindmain{MPI\_IREDUCE\_SCATTER}{(SENDBUF, RECVBUF, RECVCOUNTS, DATATYPE, OP, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNTS(*)}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_ISCAN}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iscan}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iscan\_c}
\mpibindmain{MPI\_Iscan\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iscan}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Iscan}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ISCAN}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_IEXSCAN}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Iexscan}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\MPIbindindex{MPI\_Iexscan\_c}
\mpibindmain{MPI\_Iexscan\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Iexscan}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Iexscan}{(sendbuf, recvbuf, count, datatype, op, comm, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_IEXSCAN}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_BARRIER\_INIT}{(\mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\IN}{info}{info argument (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Barrier\_init}{(\gb{}MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Barrier\_init}{(comm, info, request, ierror) \fargs TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BARRIER\_INIT}{(COMM, INFO, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_BCAST\_INIT}{(\mbox{buffer}, \mbox{count}, \mbox{datatype}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\INOUT}{buffer}{starting address of buffer (choice)}
\funcarg{\IN}{count}{number of entries in buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of buffer (handle)}
\funcarg{\IN}{root}{rank of broadcast root (integer)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Bcast\_init}{(\gb{}void~*buffer, int~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Bcast\_init\_c}
\mpibindmain{MPI\_Bcast\_init\_c}{(\gb{}void~*buffer, MPI\_Count~count, MPI\_Datatype~datatype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Bcast\_init}{(buffer, count, datatype, root, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Bcast\_init}{(buffer, count, datatype, root, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{buffer}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_BCAST\_INIT}{(BUFFER, COUNT, DATATYPE, ROOT, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{BUFFER(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_GATHER\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Gather\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Gather\_init\_c}
\mpibindmain{MPI\_Gather\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
...
\mpifbindmain{MPI\_GATHER\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a persistent collective communication request for the gather operation
(see Section~\ref{sec:coll-gather}).

% Upgraded w/info
\begin{funcdef}{MPI\_GATHERV\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Gatherv\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Gatherv\_init\_c}
\mpibindmain{MPI\_Gatherv\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Gatherv\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Gatherv\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{displs(*)}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_GATHERV\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, ROOT, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_SCATTER\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer, significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scatter\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Scatter\_init\_c}
\mpibindmain{MPI\_Scatter\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Scatter\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Scatter\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SCATTER\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, ROOT, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{ROOT}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a persistent collective communication request for the scatter operation
(see Section~\ref{sec:coll-scatter}).

\begin{funcdef}{MPI\_SCATTERV\_INIT}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{displs}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice, significant only at root)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each \MPI/ process (significant only at root)}
\funcarg{\IN}{displs}{integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data to \MPI/ process \mpicode{i} (significant only at root)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle, significant only at root)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scatterv\_init}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~displs[], MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Scatterv\_init\_c}
\mpibindmain{MPI\_Scatterv\_init\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Scatterv\_init}{(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcount}, \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
...
\begin{funcdef}{MPI\_ALLGATHER\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{number of elements received from each \MPI/ process (nonnegative integer)}
\funcarg{\IN}{recvtype}{datatype of receive buffer elements (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\IN}{info}{info argument (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allgather\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Allgather\_init\_c}
\mpibindmain{MPI\_Allgather\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
...
\mpifbindmain{MPI\_ALLGATHER\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a persistent collective communication request for the allgather operation
(see Section~\ref{sec:coll-allcast}).

\begin{funcdef}{MPI\_ALLGATHERV\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{displs}, \mbox{recvtype}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allgatherv\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Allgatherv\_init\_c}
\mpibindmain{MPI\_Allgatherv\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~displs[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Allgatherv\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}, \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Allgatherv\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{displs(*)}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLGATHERV\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS, DISPLS, RECVTYPE, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{DISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{funcdef}{MPI\_ALLTOALL\_INIT}{(\mbox{sendbuf}, \mbox{sendcount}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{recvtype}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcount}{number of elements sent to each \MPI/ process (nonnegative integer)}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoall\_init}{(\gb{}const~void~*sendbuf, int~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, int~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Alltoall\_init\_c}
\mpibindmain{MPI\_Alltoall\_init\_c}{(\gb{}const~void~*sendbuf, MPI\_Count~sendcount, MPI\_Datatype~sendtype, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Alltoall\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoall\_init}{(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{sendcount}, \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALL\_INIT}{(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT, RECVTYPE, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNT}, \mbox{SENDTYPE}, \mbox{RECVCOUNT}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a persistent collective communication request for the alltoall operation
(see Section~\ref{sec:coll-alltoall}).

\begin{funcdef}{MPI\_ALLTOALLV\_INIT}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtype}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtype}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{nonnegative integer array (of length group size) specifying the number of elements to send to each \MPI/ process}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j}}
\funcarg{\IN}{sendtype}{datatype of send buffer elements (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoallv\_init}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Alltoallv\_init\_c}
\mpibindmain{MPI\_Alltoallv\_init\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], MPI\_Datatype~sendtype, void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], MPI\_Datatype~recvtype, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Alltoallv\_init}{(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoallv\_init}{(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sdispls(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{sendtype}, \mbox{recvtype}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALLV\_INIT}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPE}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPE}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}

Creates a persistent collective communication request for the alltoallv operation
(see Section~\ref{sec:coll-alltoall}).


\begin{funcdef}{MPI\_ALLTOALLW\_INIT}{(\mbox{sendbuf}, \mbox{sendcounts}, \mbox{sdispls}, \mbox{sendtypes}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{rdispls}, \mbox{recvtypes}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\IN}{sendcounts}{integer array (of length group size) specifying the number of elements to send to each \MPI/ process (array of nonnegative integers)}
\funcarg{\IN}{sdispls}{integer array (of length group size). Entry \mpicode{j} specifies the displacement in bytes (relative to \mpiarg{sendbuf}) from which to take the outgoing data destined for \MPI/ process \mpicode{j} (array of integers)}
\funcarg{\IN}{sendtypes}{array of datatypes (of length group size). Entry \mpicode{j} specifies the type of data to send to \MPI/ process \mpicode{j} (array of handles)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Alltoallw\_init}{(\gb{}const~void~*sendbuf, const~int~sendcounts[], const~int~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~int~recvcounts[], const~int~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Alltoallw\_init\_c}
\mpibindmain{MPI\_Alltoallw\_init\_c}{(\gb{}const~void~*sendbuf, const~MPI\_Count~sendcounts[], const~MPI\_Aint~sdispls[], const~MPI\_Datatype~sendtypes[], void~*recvbuf, const~MPI\_Count~recvcounts[], const~MPI\_Aint~rdispls[], const~MPI\_Datatype~recvtypes[], MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Alltoallw\_init}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{sdispls(*)}, \mbox{recvcounts(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Alltoallw\_init}{(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendcounts(*)}, \mbox{recvcounts(*)}\fnarg{}INTEGER(KIND=MPI\_ADDRESS\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sdispls(*)}, \mbox{rdispls(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendtypes(*)}, \mbox{recvtypes(*)}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLTOALLW\_INIT}{(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPES, RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPES, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{SENDCOUNTS(*)}, \mbox{SDISPLS(*)}, \mbox{SENDTYPES(*)}, \mbox{RECVCOUNTS(*)}, \mbox{RDISPLS(*)}, \mbox{RECVTYPES(*)}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{root}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{address of receive buffer (choice, significant only at root)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Reduce\_init\_c}
\mpibindmain{MPI\_Reduce\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, int~root, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Reduce\_init}{(sendbuf, recvbuf, count, datatype, op, root, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}, \mbox{root}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_init}{(sendbuf, recvbuf, count, datatype, op, root, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{root}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_INIT}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, ROOT, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{ROOT}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_ALLREDUCE\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in send buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Allreduce\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Allreduce\_init\_c}
\mpibindmain{MPI\_Allreduce\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Allreduce\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Allreduce\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_ALLREDUCE\_INIT}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_SCATTER\_BLOCK\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcount}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcount}{element count per block (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of send and receive buffers (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_scatter\_block\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Reduce\_scatter\_block\_init\_c}
\mpibindmain{MPI\_Reduce\_scatter\_block\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~recvcount, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Reduce\_scatter\_block\_init}{(sendbuf, recvbuf, recvcount, datatype, op, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_scatter\_block\_init}{(sendbuf, recvbuf, recvcount, datatype, op, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{recvcount}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_SCATTER\_BLOCK\_INIT}{(SENDBUF, RECVBUF, RECVCOUNT, DATATYPE, OP, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_REDUCE\_SCATTER\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{recvcounts}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{recvcounts}{nonnegative integer array specifying the number of elements in result distributed to each \MPI/ process. This array must be identical on all calling \MPI/ processes.}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
\funcarg{\IN}{op}{operation (handle)}
\funcarg{\IN}{comm}{communicator (handle)}
\funcarg{\IN}{info}{info argument (handle)}
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Reduce\_scatter\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~int~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Reduce\_scatter\_init\_c}
\mpibindmain{MPI\_Reduce\_scatter\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, const~MPI\_Count~recvcounts[], MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Reduce\_scatter\_init}{(sendbuf, recvbuf, recvcounts, datatype, op, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Reduce\_scatter\_init}{(sendbuf, recvbuf, recvcounts, datatype, op, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{recvcounts(*)}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_REDUCE\_SCATTER\_INIT}{(SENDBUF, RECVBUF, RECVCOUNTS, DATATYPE, OP, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{RECVCOUNTS(*)}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_SCAN\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Scan\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Scan\_init\_c}
\mpibindmain{MPI\_Scan\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Scan\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Scan\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_SCAN\_INIT}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Op}%
\begin{funcdef}{MPI\_EXSCAN\_INIT}{(\mbox{sendbuf}, \mbox{recvbuf}, \mbox{count}, \mbox{datatype}, \mbox{op}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{sendbuf}{starting address of send buffer (choice)}
\funcarg{\OUT}{recvbuf}{starting address of receive buffer (choice)}
\funcarg{\IN}{count}{number of elements in input buffer (nonnegative integer)}
\funcarg{\IN}{datatype}{datatype of elements of input buffer (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Exscan\_init}{(\gb{}const~void~*sendbuf, void~*recvbuf, int~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\MPIbindindex{MPI\_Exscan\_init\_c}
\mpibindmain{MPI\_Exscan\_init\_c}{(\gb{}const~void~*sendbuf, void~*recvbuf, MPI\_Count~count, MPI\_Datatype~datatype, MPI\_Op~op, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Exscan\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifnewbindmain{MPI\_Exscan\_init}{(sendbuf, recvbuf, count, datatype, op, comm, info, request, ierror) !(\_c) \fargs TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS\ ::\ \mbox{sendbuf}\fnarg{}TYPE(*), DIMENSION(..), ASYNCHRONOUS\ ::\ \mbox{recvbuf}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Op), INTENT(IN)\ ::\ \mbox{op}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_EXSCAN\_INIT}{(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{SENDBUF(*)}, \mbox{RECVBUF(*)}\fnfinalarg{}INTEGER \mbox{COUNT}, \mbox{DATATYPE}, \mbox{OP}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}}
...
\begin{figure}[h]
  \centerline{\includegraphics[width=4.00in]{figures/coll-matchings}}
...
\begin{figure}[hb]
  \centerline{\includegraphics[width=2.50in]{figures/overlap_comms}}
