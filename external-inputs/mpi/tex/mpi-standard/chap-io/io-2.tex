...
\begin{mpi-binding}
    ...
    parameter("filename", "STRING", desc=r"name of file to open", constant=True)
    parameter("amode", "ACCESS_MODE", desc=r"file access mode")
    parameter("info", "INFO", desc=r"info object")
    parameter("fh", "FILE", desc=r"new file handle", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter("fh", "FILE", desc=r"file handle", direction="inout")
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_File_delete")
    
    parameter(
        "filename", "STRING", desc=r"name of file to delete", constant=True
    )
    parameter("info", "INFO", desc=r"info object")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_File_set_size")
    
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("size", "OFFSET", desc=r"size to truncate or expand file")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_preallocate")
    
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("size", "OFFSET", desc=r"size to preallocate file")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_get_size")
    
    parameter("fh", "FILE", desc=r"file handle")
    parameter(
        "size", "OFFSET", desc=r"size of the file in bytes", direction="out"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_get_group")
    
    parameter("fh", "FILE", desc=r"file handle")
    parameter(
        "group", "GROUP", desc=r"group that opened the file", direction="out"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_get_amode")
    parameter("fh", "FILE", desc=r"file handle")
    parameter(
        "amode",
        "ACCESS_MODE",
        desc=r"file access mode used to open the file",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_set_info")
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_get_info")
    
    parameter("fh", "FILE", desc=r"file handle", direction="in")
    parameter("info_used", "INFO", desc=r"new info object", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("disp", "OFFSET", desc=r"displacement")
    parameter("etype", "DATATYPE", desc=r"elementary datatype")
    parameter("filetype", "DATATYPE", desc=r"filetype")
    parameter("datarep", "STRING", desc=r"data representation", constant=True)
    parameter("info", "INFO", desc=r"info object")
\end{mpi-binding}
...
\begin{figure}[htpb]
  \centerline{\includegraphics[width=4.0in]{figures/io-disp}}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_get_view")
    
    parameter("fh", "FILE", desc=r"file handle", direction="in")
    parameter("disp", "OFFSET", desc=r"displacement", direction="out")
    parameter("etype", "DATATYPE", desc=r"elementary datatype", direction="out")
    parameter("filetype", "DATATYPE", desc=r"filetype", direction="out")
    parameter("datarep", "STRING", desc=r"data representation", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_read_at")
    
    parameter("fh", "FILE", desc=r"file handle", direction="in")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter(
        "buf", "BUFFER", desc=r"initial address of buffer", direction="out"
    )
    parameter("count", "POLYXFER_NUM_ELEM", desc=r"number of elements in buffer")
    parameter("datatype", "DATATYPE", desc=r"datatype of each buffer element")
    parameter("status", "STATUS", desc=r"status object", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_read_at_all")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_write_at")
    
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter("buf", "BUFFER", desc=r"initial address of buffer", constant=True)
    parameter("count", "POLYXFER_NUM_ELEM", desc=r"number of elements in buffer")
    parameter("datatype", "DATATYPE", desc=r"datatype of each buffer element")
    parameter("status", "STATUS", desc=r"status object", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_write_at_all")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_iread_at")
    
    parameter(
        "fh", "FILE", desc=r"file handle", direction="in"
    )
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter(
        "buf",
        "BUFFER",
        desc=r"initial address of buffer",
        direction="out",
        suppress="f08_intent",
        asynchronous=True,
    )
    parameter("count", "POLYXFER_NUM_ELEM", desc=r"number of elements in buffer")
    parameter("datatype", "DATATYPE", desc=r"datatype of each buffer element")
    parameter("request", "REQUEST", desc=r"request object", direction="out")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_iread_at_all")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_iwrite_at")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_iwrite_at_all")
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_all")
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_all")
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_iread_all")
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_iwrite_all")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_seek")
    
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter("whence", "UPDATE_MODE", desc=r"update mode")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_get_position")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:in,param:in")
    parameter(
        "offset", "OFFSET", desc=r"offset of individual pointer", direction="out"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_get_byte_offset")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:in,param:in")
    parameter("offset", "OFFSET", desc=r"offset")
    parameter(
        "disp",
        "OFFSET",
        desc=r"absolute byte position of offset",
        direction="out",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_shared")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf", "BUFFER", desc=r"initial address of buffer", direction="out"
    )
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_shared")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("buf", "BUFFER", desc=r"initial address of buffer", constant=True)
    parameter("count", "POLYXFER_NUM_ELEM", desc=r"number of elements in buffer")
    parameter("datatype", "DATATYPE", desc=r"datatype of each buffer element")
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_iread_shared")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_iwrite_shared")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_ordered")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf", "BUFFER", desc=r"initial address of buffer", direction="out"
    )
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_ordered")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("buf", "BUFFER", desc=r"initial address of buffer", constant=True)
    parameter("count", "POLYXFER_NUM_ELEM", desc=r"number of elements in buffer")
    parameter("datatype", "DATATYPE", desc=r"datatype of each buffer element")
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_seek_shared")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter("whence", "UPDATE_MODE", desc=r"update mode")
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_get_position_shared")
    parameter("fh", "FILE", desc=r"file handle")
    parameter(
        "offset", "OFFSET", desc=r"offset of shared pointer", direction="out"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_read_at_all_begin")
    parameter("fh", "FILE", desc=r"file handle")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter(
        "buf",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_at_all_end")
    parameter("fh", "FILE", desc=r"file handle")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Offset}%
\begin{mpi-binding}
    function_name("MPI_File_write_at_all_begin")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter("offset", "OFFSET", desc=r"file offset")
    parameter(
        "buf",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_at_all_end")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_read_all_begin")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_all_end")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_write_all_begin")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_all_end")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_read_ordered_begin")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_read_ordered_end")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_write_ordered_begin")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\cdeclindex{MPI\_Status}%
\begin{mpi-binding}
    function_name("MPI_File_write_ordered_end")
    parameter("fh", "FILE", desc=r"file handle", direction="lis:inout,param:in")
    parameter(
        "buf",
        "BUFFER",
...
\begin{mpi-binding}
    function_name("MPI_File_get_type_extent")
    parameter("fh", "FILE", desc=r"file handle")
    parameter("datatype", "DATATYPE", desc=r"datatype")
    parameter(
        "extent", "POLYDISPOFFSET", desc=r"datatype extent", direction="out"
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Register_datarep")
    not_abstract_interface()

    parameter(
        "datarep",
        "STRING",
        desc=r"data representation identifier",
        constant=True,
    )
    parameter(
        "read_conversion_fn",
        "POLYFUNCTION",
        desc=r"function invoked to convert from file representation to native representation",
        func_type="MPI_Datarep_conversion_function",
    )
    parameter(
        "write_conversion_fn",
        "POLYFUNCTION",
        desc=r"function invoked to convert from native representation to file representation",
        func_type="MPI_Datarep_conversion_function",
    )
    parameter(
        "dtype_file_extent_fn",
        "FUNCTION",
        desc=r"function invoked to get the extent of a datatype as represented in the file",
        func_type="MPI_Datarep_extent_function",
    )
...
\begin{mpi-binding}
    callback()
    function_name("MPI_Datarep_extent_function", "DATAREP_EXTENT_FUNCTION")
    no_lis_binding()
    
    parameter("datatype", "DATATYPE")
    parameter("extent", "DISPOFFSET_SMALL", direction="out")
    parameter("extra_state", "EXTRA_STATE", direction="out")
...
\begin{mpi-binding}
    callback()
    function_name(
        "MPI_Datarep_conversion_function", "DATAREP_CONVERSION_FUNCTION"
    )
    no_lis_binding()
    
    parameter("userbuf", "C_BUFFER3", direction='inout')
    parameter("datatype", "DATATYPE")
    parameter("count", "POLYXFER_NUM_ELEM")
    parameter("filebuf", "C_BUFFER3", direction='inout')
    parameter("position", "OFFSET")
    parameter("extra_state", "EXTRA_STATE", direction='inout')
...
\begin{mpi-binding}
    predefined_function("MPI_Datarep_conversion_function")
    no_lis_binding()
    
    function_name("MPI_CONVERSION_FN_NULL", capitalized=True)
    not_abstract_interface()
    
    parameter("userbuf", "C_BUFFER3")
    parameter("datatype", "DATATYPE")
    parameter("count", "POLYXFER_NUM_ELEM")
    parameter("filebuf", "C_BUFFER3")
    parameter("position", "OFFSET")
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_set_atomicity")
    ...
    parameter(
        ...
        "LOGICAL",
        desc=(
            "\\mpicode{true} to set atomic mode, \\mpicode{false} to "
            "set nonatomic mode"
        ),
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_File}%
\begin{mpi-binding}
    function_name("MPI_File_get_atomicity")
    ...
    parameter(
        ...
        "LOGICAL",
        desc=(
            "\\mpicode{true} if atomic mode, \\mpicode{false} if "
            "nonatomic mode"
        ),
        direction="out",
    )
