...
\begin{mpi-binding}
    function_name("MPI_Type_create_f90_real")

    parameter("p", "MATH", desc=r"precision, in decimal digits")
    parameter("r", "MATH", desc=r"decimal exponent range")
    parameter(
        "newtype",
        "DATATYPE",
        direction="out",
        desc=r"the requested \MPI/ datatype",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_f90_complex")
...
\begin{mpi-binding}
    function_name("MPI_Type_create_f90_integer")

    parameter(
        "r",
        "MATH",
        desc=r"decimal exponent range, i.e., number of decimal digits",
    )
    parameter(
        "newtype",
        "DATATYPE",
...
\begin{mpi-binding}
    function_name("MPI_Type_match_size")

    parameter("typeclass", "TYPECLASS", desc=r"generic type specifier")
    parameter(
        "size", "TYPECLASS_SIZE", desc=r"size, in bytes, of representation"
    )
    parameter(
        "datatype",
        "DATATYPE",
        direction="out",
        desc=r"datatype with correct type, size",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Comm_f2c')
    return_type("COMMUNICATOR")

    parameter("comm", "F90_COMM", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Comm_c2f')
    return_type("F90_COMM")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Type_f2c')
    return_type("DATATYPE")

    parameter("datatype", "F90_DATATYPE", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Type_c2f')
    return_type("F90_DATATYPE")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Group_f2c')
    return_type("GROUP")

    parameter("group", "F90_GROUP", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Group_c2f')
    return_type("F90_GROUP")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Request_f2c')
    return_type("REQUEST")

    parameter("request", "F90_REQUEST", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Request_c2f')
    return_type("F90_REQUEST")
...
\begin{mpi-binding}
    ...
    function_name('MPI_File_f2c')
    return_type("FILE")

    parameter("file", "F90_FILE", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_File_c2f')
    return_type("F90_FILE")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Win_f2c')
    return_type("WINDOW")

    parameter("win", "F90_WIN", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Op_f2c')
    return_type("OPERATION")

    parameter("op", "F90_OP", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Info_f2c')
    return_type("INFO")

    parameter("info", "F90_INFO", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Info_c2f')
    return_type("F90_INFO")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Errhandler_f2c')
    return_type("ERRHANDLER")

    parameter("errhandler", "F90_ERRHANDLER", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Errhandler_c2f')
    return_type("F90_ERRHANDLER")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Message_f2c')
    return_type("MESSAGE")

    parameter("message", "F90_MESSAGE", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Message_c2f')
    return_type("F90_MESSAGE")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Session_f2c')
    return_type("SESSION")

    parameter("session", "F90_SESSION", direction="in", pointer=False)
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Session_c2f')
    return_type("F90_SESSION")
...
\begin{mpi-binding}
    ...
    function_name('MPI_Status_f2c')
    return_type("ERROR_CLASS")

    parameter("f_status", "F90_STATUS", direction="in", constant=True)
    parameter("c_status", "STATUS", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Status_c2f')
    return_type("ERROR_CLASS")

    parameter("c_status", "STATUS", direction="in", constant=True)
    parameter("f_status", "F90_STATUS", direction="out")
\end{mpi-binding}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=120mm]{figures/status-conversion-triangle}}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Status_f082c')
    return_type("ERROR_CLASS")

    parameter("f08_status", "F08_STATUS", direction="in", constant=True)
    parameter("c_status", "STATUS", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    function_name('MPI_Status_c2f08')
    return_type("ERROR_CLASS")

    parameter("c_status", "STATUS", direction="in", constant=True)
    parameter("f08_status", "F08_STATUS", direction="out")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    # The F90 renderings of this function need to have "::"
    f90_use_colons()
    not_with_mpif()
    ...
    parameter(
        ...
        pointer=True,
        constant=True,
        desc=r"status object declared as array",
    )
    parameter(
        "f08_status",
        "F08_STATUS",
        direction="out",
        desc=r"status object declared as named type",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Status_f082f")
