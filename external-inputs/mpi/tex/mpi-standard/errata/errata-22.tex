...
\chapter{Errata for \mpiiidotii/}

This document was processed on \today.
\vskip 0.3truein

The known corrections to \mpiiidotii/ are listed in this document.  All
page and line numbers are for the official version of the \mpiiidotii/
...
the MPI Forum.  Such items are marked as \textbf{Pending Errata}.
\fi

\begin{itemize}

\item Page xxiv after line 13, add
\begin{quote}
Intel Corporation
\end{quote}

\item Section 13.5.2 page 433 line 22 table 13.2. Change:
\begin{verbatim}
MPI_C_BOOL 	4
\end{verbatim}
To:
