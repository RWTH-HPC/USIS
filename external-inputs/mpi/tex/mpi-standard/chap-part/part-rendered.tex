...
\begin{funcdef}{MPI\_PSEND\_INIT}{(\mbox{buf}, \mbox{partitions}, \mbox{count}, \mbox{datatype}, \mbox{dest}, \mbox{tag}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of send buffer (choice)}
\funcarg{\IN}{partitions}{number of partitions (nonnegative integer)}
\funcarg{\IN}{count}{number of elements sent per partition (nonnegative integer)}
...
\end{funcdef}
\mpibindmain{MPI\_Psend\_init}{(\gb{}const~void~*buf, int~partitions, MPI\_Count~count, MPI\_Datatype~datatype, int~dest, int~tag, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Psend\_init}{(buf, partitions, count, datatype, dest, tag, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{partitions}, \mbox{dest}, \mbox{tag}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PSEND\_INIT}{(BUF, PARTITIONS, COUNT, DATATYPE, DEST, TAG, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnarg{}INTEGER \mbox{PARTITIONS}, \mbox{DATATYPE}, \mbox{DEST}, \mbox{TAG}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}\fnfinalarg{}INTEGER(KIND=MPI\_COUNT\_KIND) \mbox{COUNT}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_PRECV\_INIT}{(\mbox{buf}, \mbox{partitions}, \mbox{count}, \mbox{datatype}, \mbox{source}, \mbox{tag}, \mbox{comm}, \mbox{info}, \mbox{request})}
\funcarg{\IN}{buf}{initial address of recv buffer (choice)}
\funcarg{\IN}{partitions}{number of partitions (nonnegative integer)}
\funcarg{\IN}{count}{number of elements received per partition (nonnegative integer)}
\funcarg{\IN}{datatype}{type of each element (handle)}
...
\funcarg{\OUT}{request}{communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Precv\_init}{(\gb{}void~*buf, int~partitions, MPI\_Count~count, MPI\_Datatype~datatype, int~source, int~tag, MPI\_Comm~comm, MPI\_Info~info, MPI\_Request~*request)}
\mpifnewbindmain{MPI\_Precv\_init}{(buf, partitions, count, datatype, source, tag, comm, info, request, ierror) \fargs TYPE(*), DIMENSION(..), INTENT(IN)\ ::\ \mbox{buf}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{partitions}, \mbox{source}, \mbox{tag}\fnarg{}INTEGER(KIND=MPI\_COUNT\_KIND), INTENT(IN)\ ::\ \mbox{count}\fnarg{}TYPE(MPI\_Datatype), INTENT(IN)\ ::\ \mbox{datatype}\fnarg{}TYPE(MPI\_Comm), INTENT(IN)\ ::\ \mbox{comm}\fnarg{}TYPE(MPI\_Info), INTENT(IN)\ ::\ \mbox{info}\fnarg{}TYPE(MPI\_Request), INTENT(OUT)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PRECV\_INIT}{(BUF, PARTITIONS, COUNT, DATATYPE, SOURCE, TAG, COMM, INFO, REQUEST, IERROR) \fargs <type> \mbox{BUF(*)}\fnarg{}INTEGER \mbox{PARTITIONS}, \mbox{DATATYPE}, \mbox{SOURCE}, \mbox{TAG}, \mbox{COMM}, \mbox{INFO}, \mbox{REQUEST}, \mbox{IERROR}\fnfinalarg{}INTEGER(KIND=MPI\_COUNT\_KIND) \mbox{COUNT}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_PREADY}{(\mbox{partition}, \mbox{request})}
\funcarg{\IN}{partition}{partition to mark ready for transfer (nonnegative integer)}
\funcarg{\INOUT}{request}{partitioned communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Pready}{(\gb{}int~partition, MPI\_Request~request)}
\mpifnewbindmain{MPI\_Pready}{(partition, request, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{partition}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PREADY}{(PARTITION, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{PARTITION}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_PREADY\_RANGE}{(\mbox{partition\_low}, \mbox{partition\_high}, \mbox{request})}
\funcarg{\IN}{partition\_low}{lowest partition ready for transfer (nonnegative integer)}
\funcarg{\IN}{partition\_high}{highest partition ready for transfer (nonnegative integer)}
\funcarg{\INOUT}{request}{partitioned communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Pready\_range}{(\gb{}int~partition\_low, int~partition\_high, MPI\_Request~request)}
\mpifnewbindmain{MPI\_Pready\_range}{(partition\_low, partition\_high, request, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{partition\_low}, \mbox{partition\_high}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PREADY\_RANGE}{(PARTITION\_LOW, PARTITION\_HIGH, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{PARTITION\_LOW}, \mbox{PARTITION\_HIGH}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_PREADY\_LIST}{(\mbox{length}, \mbox{array\_of\_partitions}, \mbox{request})}
\funcarg{\IN}{length}{list length (integer)}
\funcarg{\IN}{array\_of\_partitions}{array of partitions (array of nonnegative integers)}
\funcarg{\INOUT}{request}{partitioned communication request (handle)}
\end{funcdef}
\mpibindmain{MPI\_Pready\_list}{(\gb{}int~length, const~int~array\_of\_partitions[], MPI\_Request~request)}
\mpifnewbindmain{MPI\_Pready\_list}{(length, array\_of\_partitions, request, ierror) \fargs INTEGER, INTENT(IN)\ ::\ \mbox{length}, \mbox{array\_of\_partitions(length)}\fnarg{}TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PREADY\_LIST}{(LENGTH, ARRAY\_OF\_PARTITIONS, REQUEST, IERROR) \fargs \fnfinalarg{}INTEGER \mbox{LENGTH}, \mbox{ARRAY\_OF\_PARTITIONS(*)}, \mbox{REQUEST}, \mbox{IERROR}}
...
\cdeclindex{MPI\_Request}
\begin{funcdef}{MPI\_PARRIVED}{(\mbox{request}, \mbox{partition}, \mbox{flag})}
\funcarg{\IN}{request}{partitioned communication request (handle)}
\funcarg{\IN}{partition}{partition to be tested (nonnegative integer)}
\funcarg{\OUT}{flag}{\mpicode{true} if operation completed on the specified partition, \mpicode{false} if not (logical)}
\end{funcdef}
\mpibindmain{MPI\_Parrived}{(\gb{}MPI\_Request~request, int~partition, int~*flag)}
\mpifnewbindmain{MPI\_Parrived}{(request, partition, flag, ierror) \fargs TYPE(MPI\_Request), INTENT(IN)\ ::\ \mbox{request}\fnarg{}INTEGER, INTENT(IN)\ ::\ \mbox{partition}\fnarg{}LOGICAL, INTENT(OUT)\ ::\ \mbox{flag}\fnfinalarg{}INTEGER, OPTIONAL, INTENT(OUT)\ ::\ \mbox{ierror}}
\mpifbindmain{MPI\_PARRIVED}{(REQUEST, PARTITION, FLAG, IERROR) \fargs INTEGER \mbox{REQUEST}, \mbox{PARTITION}, \mbox{IERROR}\fnfinalarg{}LOGICAL \mbox{FLAG}}
