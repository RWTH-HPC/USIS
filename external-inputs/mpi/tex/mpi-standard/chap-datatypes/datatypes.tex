...
\begin{mpi-binding}
    function_name("MPI_Type_contiguous")
    parameter("count", "POLYDTYPE_NUM_ELEM_NNI", desc=r"replication count")
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_vector")
    parameter("count", "POLYDTYPE_NUM_ELEM_NNI", desc=r"number of blocks")
    parameter(
        "blocklength",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=r"number of elements in each block",
    )
    parameter(
        "stride",
        "POLYDTYPE_NUM_ELEM",
        desc=r"number of elements between start of each block",
    )
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_hvector")
    parameter("count", "POLYDTYPE_NUM_ELEM_NNI", desc=r"number of blocks")
    parameter(
        "blocklength",
        "POLYDTYPE_NUM_ELEM_NNI",
    ...
    parameter(
        ...
        desc=r"number of bytes between start of each block",
    )
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter(
        ...
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=(
            r"number of blocks---also number of entries in "
            r"\mpiarg{array_of_displacements} and "
            r"\mpiarg{array_of_blocklengths}"
        ),
    )
    parameter(
        ...
        length="count",
        constant=True,
        desc=r"number of elements per block",
    )
    ...
    parameter(
        ...
        length="count",
        constant=True,
        desc=r"displacement for each block, in multiples of \mpiarg{oldtype}",
    )
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_create_hindexed")
    parameter(
        "count",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=(
            "number of blocks---also number of entries in "
            "\\mpiarg{array_of_displacements} and "
            "\\mpiarg{array_of_blocklengths}"
        ),
    )
    parameter(
        "array_of_blocklengths",
    ...
    parameter(
        ...
        length="count",
        constant=True,
        desc=r"byte displacement of each block",
    )
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_indexed_block")
    parameter(
        "count",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=r"number of blocks---also number of entries in "
            r"\mpiarg{array_of_displacements}",
    )
    parameter(
         "blocklength", "POLYDTYPE_NUM_ELEM_NNI",
         desc=r"number of elements in each block")
    parameter(
        "array_of_displacements",
        "POLYDISPLACEMENT_COUNT",
        length="count",
        constant=True,
        desc=r"array of displacements, in multiples of \mpiarg{oldtype}",
    )
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_hindexed_block")
    parameter(
        "count",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=r"number of blocks---also number of entries in "
    ...
    parameter("blocklength", "POLYDTYPE_NUM_ELEM_NNI",
        desc=r"number of elements in each block"
    )
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_create_struct")
    parameter(
        "count",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=(
            "number of blocks---also number of entries in arrays "
            r"\mpiarg{array_of_types}, \mpiarg{array_of_displacements}, "
            r"and \mpiarg{array_of_blocklengths}"
        ),
    )
    parameter(
        "array_of_blocklengths",
    ...
    parameter(
        ...
        constant=True,
        length="count",
        desc=r"type of elements in each block",
    )
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_subarray")
    parameter("ndims", "ARRAY_LENGTH_PI", desc=r"number of array dimensions")
    parameter(
        "array_of_sizes",
        ...
        constant=True,
        desc=(
            r"number of elements of type \mpiarg{oldtype} in each dimension "
            "of the full array"
        ),
    )
    parameter(
    ...
    parameter(
        ...
        length="ndims",
        constant=True,
        desc=r"starting coordinates of the subarray in each dimension",
    )
    parameter("order", "ORDER", desc=r"array storage order flag")
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_create_darray")
    parameter("size", "COMM_SIZE_PI", desc=r"size of process group")
    parameter("rank", "RANK_NNI", desc=r"rank in process group")
    parameter(
        "ndims",
        "ARRAY_LENGTH_PI",
        desc=r"number of array dimensions as well as process grid dimensions",
    )
    parameter(
        "array_of_gsizes",
        "POLYDTYPE_NUM_ELEM_PI",
    ...
    parameter(
        ...
        constant=True,
        length="ndims",
        desc=r"distribution of array in each dimension",
    )
    parameter(
        "array_of_dargs",
        "DTYPE_DISTRIBUTION",
        constant=True,
        length="ndims",
        desc=r"distribution argument in each dimension",
    )
    parameter(
        "array_of_psizes",
        "PROCESS_GRID_SIZE",
        constant=True,
        length="ndims",
        desc=r"size of process grid in each dimension",
    )
    parameter("order", "ORDER", desc=r"array storage order flag")
    parameter("oldtype", "DATATYPE", desc=r"old datatype")
    parameter("newtype", "DATATYPE", direction="out", desc=r"new datatype")
...
\begin{mpi-binding}
    ...
    parameter(
        ...
        asynchronous=True,
        suppress="f08_intent",
        desc=r"location in caller memory",
    )
    parameter(
        "address", "DISPLACEMENT", direction="out", desc=r"address of location"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Aint_add")
    no_ierror()
    return_type("LOCATION_SMALL")
    parameter("base", "LOCATION_SMALL", desc=r"base address")
    parameter("disp", "DISPLACEMENT", desc=r"displacement")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Aint_diff")
    no_ierror()
    return_type("DISPLACEMENT")
    parameter("addr1", "LOCATION_SMALL", desc=r"minuend address")
    parameter("addr2", "LOCATION_SMALL", desc=r"subtrahend address")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_size")
    parameter("datatype", "DATATYPE", desc=r"datatype to get information on")
    parameter(
        "size", "POLYXFER_NUM_ELEM", direction="out", desc=r"datatype size"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_get_extent")
    parameter("datatype", "DATATYPE", desc=r"datatype to get information on")
    parameter(
        "lb",
        "POLYDISPLACEMENT_AINT_COUNT",
        direction="out",
        desc=r"lower bound of datatype",
    )
    parameter(
        "extent",
        "POLYDISPLACEMENT_AINT_COUNT",
        direction="out",
        desc=r"extent of datatype",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_create_resized")
    parameter("oldtype", "DATATYPE", desc=r"input datatype")
    parameter(
        "lb", "POLYDISPLACEMENT_AINT_COUNT", desc=r"new lower bound of datatype"
    )
    parameter(
        "extent", "POLYDISPLACEMENT_AINT_COUNT", desc=r"new extent of datatype"
    )
    parameter("newtype", "DATATYPE", direction="out", desc=r"output datatype")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_get_true_extent")
    parameter("datatype", "DATATYPE", desc=r"datatype to get information on")
    parameter(
        "true_lb",
        "POLYDISPLACEMENT_AINT_COUNT",
...
\begin{mpi-binding}
    function_name("MPI_Type_commit")
    parameter(
        "datatype",
        "DATATYPE",
        direction="inout",
        desc=r"datatype that is committed",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_free")
    parameter(
        "datatype", "DATATYPE", direction="inout", desc=r"datatype that is freed"
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Type_dup")
    parameter("oldtype", "DATATYPE", desc=r"datatype")
    parameter(
        "newtype", "DATATYPE", direction="out", desc=r"copy of \mpiarg{oldtype}"
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Get_elements")
    parameter(
...
\begin{mpi-binding}
    function_name("MPI_Type_get_envelope")
    parameter("datatype", "DATATYPE", desc=r"datatype to decode")
    parameter(
        "num_integers",
        "POLYNUM_PARAM_VALUES",
        direction="out",
        desc=r"number of input integers used in call constructing \mpiarg{combiner}",
    )
    parameter(
        "num_addresses",
        "POLYNUM_PARAM_VALUES",
        direction="out",
        desc=r"number of input addresses used in call constructing \mpiarg{combiner}",
    )
    parameter(
        "num_large_counts",
        "POLYNUM_PARAM_VALUES",
        direction="out",
        desc=r"number of input large counts used in call constructing \mpiarg{combiner}",
        large_only=True
    )
    parameter(
        "num_datatypes",
        "POLYNUM_PARAM_VALUES",
        direction="out",
        desc=r"number of input datatypes used in call constructing \mpiarg{combiner}",
    )
    parameter("combiner", "COMBINER", direction="out", desc=r"combiner")
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Type_get_contents")
    parameter("datatype", "DATATYPE", desc=r"datatype to decode")

    parameter(
        "max_integers",
        "POLYNUM_PARAM_VALUES",
        desc=r"number of elements in \mpiarg{array_of_integers}",
    )
    parameter(
        "max_addresses",
        "POLYNUM_PARAM_VALUES",
        desc=r"number of elements in \mpiarg{array_of_addresses}",
    )
    parameter(
        "max_large_counts",
        "POLYNUM_PARAM_VALUES",
        desc=r"number of elements in \mpiarg{array_of_large_counts}",
        large_only=True,
    )
    parameter(
        "max_datatypes",
        "POLYNUM_PARAM_VALUES",
        desc=r"number of elements in \mpiarg{array_of_datatypes}",
    )
    ...
    parameter(
        ...
        direction="out",
        length="max_integers",
        desc=r"contains integer arguments used in constructing \mpiarg{datatype}",
    )
    parameter(
        "array_of_addresses",
        "DISPLACEMENT",
        ...
        desc=r"contains address arguments used in constructing \mpiarg{datatype}",
    )
    parameter(
        "array_of_large_counts",
        "GENERIC_DTYPE_COUNT",
        direction="out",
        length="max_large_counts",
        desc=r"contains large count arguments used in constructing \mpiarg{datatype}",
        large_only=True,
    )
    parameter(
        "array_of_datatypes",
        "DATATYPE",
        direction="out",
        length="max_datatypes",
        desc=r"contains datatype arguments used in constructing \mpiarg{datatype}",
    )
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Pack")
    parameter("inbuf", "BUFFER", constant=True, desc=r"input buffer start")
    parameter(
        "incount", "POLYDTYPE_NUM_ELEM_NNI", desc=r"number of input data items"
    )
    parameter("datatype", "DATATYPE", desc=r"datatype of each input data item")
    parameter("outbuf", "BUFFER", direction="out", desc=r"output buffer start")
    parameter(
        "outsize", "POLYNUM_BYTES_NNI", desc=r"output buffer size, in bytes"
    )
    parameter(
        "position",
        "POLYDISPLACEMENT_COUNT",
        direction="inout",
        desc=r"current position in buffer, in bytes",
    )
    parameter("comm", "COMMUNICATOR", desc=r"communicator for packed message")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Unpack")
    parameter("inbuf", "BUFFER", constant=True, desc=r"input buffer start")
    parameter(
        "insize", "POLYNUM_BYTES_NNI", desc=r"size of input buffer, in bytes"
    )
    parameter(
        "position",
        "POLYDISPLACEMENT_COUNT",
        direction="inout",
        desc=r"current position in bytes",
    )
    parameter("outbuf", "BUFFER", direction="out", desc=r"output buffer start")
    parameter(
        "outcount", "POLYDTYPE_NUM_ELEM", desc=r"number of items to be unpacked"
    )
    parameter("datatype", "DATATYPE", desc=r"datatype of each output data item")
    parameter("comm", "COMMUNICATOR", desc=r"communicator for packed message")
\end{mpi-binding}
...
\begin{mpi-binding}
    function_name("MPI_Pack_size")
    parameter(
        "incount",
        "POLYDTYPE_NUM_ELEM_NNI",
        desc=r"count argument to packing call",
    )
    parameter("datatype", "DATATYPE", desc=r"datatype argument to packing call")
    parameter(
        "comm", "COMMUNICATOR", desc=r"communicator argument to packing call"
    )
    parameter(
        "size",
        "POLYNUM_BYTES_NNI",
        direction="out",
        desc=r"upper bound on size of packed message, in bytes",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Pack_external")
    parameter(
        "datarep",
        "STRING",
        constant=True,
        desc=r"data representation",
        length="*",
    )
    parameter("inbuf", "BUFFER", constant=True, desc=r"input buffer start")
    parameter(
        "incount", "POLYDTYPE_NUM_ELEM", desc=r"number of input data items"
    )
    parameter("datatype", "DATATYPE", desc=r"datatype of each input data item")
    parameter("outbuf", "BUFFER", direction="out", desc=r"output buffer start")

    parameter(
        "outsize", "POLYDTYPE_PACK_SIZE", desc=r"output buffer size, in bytes"
    )
...
\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Unpack_external")
    parameter(
        "datarep",
        "STRING",
        constant=True,
    ...
    parameter(
        "insize", "POLYDTYPE_PACK_SIZE", desc=r"input buffer size, in bytes"
    )
    ...
    parameter("outbuf", "BUFFER", direction="out", desc=r"output buffer start")
    parameter(
        "outcount", "POLYDTYPE_NUM_ELEM", desc=r"number of output data items"
    )
    parameter("datatype", "DATATYPE", desc=r"datatype of output data item")
\end{mpi-binding}

\cdeclindex{MPI\_Aint}%
\begin{mpi-binding}
    function_name("MPI_Pack_external_size")
    parameter(
        "datarep",
        "STRING",
        constant=True,
    ...
    parameter(
        ...
        "POLYDTYPE_PACK_SIZE",
        direction="out",
        desc=r"output buffer size, in bytes",
    )
\end{mpi-binding}
