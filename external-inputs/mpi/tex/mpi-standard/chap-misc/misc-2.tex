...
\begin{mpi-binding}
    function_name("MPI_Info_create")
    
    parameter("info", "INFO", direction="out", desc=r"info object created")
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_set")
    
    parameter(
        "info", "INFO", direction="lis:inout,param:in", desc=r"info object"
    )
    parameter("key", "STRING", constant=True, desc=r"key")
    parameter("value", "STRING", constant=True, desc=r"value")
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_get_string")
    ...
    parameter(
        ...
        "LOGICAL",
        direction="out",
        desc=r"\mpicode{true} if \mpiarg{key} is defined, \mpicode{false} otherwise",
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_get_nkeys")
    
    parameter("info", "INFO", desc=r"info object")
    
    # this is a count of number of keys!
    parameter(
        "nkeys", "KEY_INDEX", direction="out", desc=r"number of defined keys"
    )
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_get_nthkey")
    
    parameter("info", "INFO", desc=r"info object")
    parameter("n", "KEY_INDEX", desc=r"key number")
    parameter("key", "STRING", direction="out", desc=r"key")
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_dup")
    
    parameter("info", "INFO", desc=r"info object")
    parameter("newinfo", "INFO", direction="out", desc=r"info object created")
\end{mpi-binding}
...
\cdeclindex{MPI\_Info}%
\begin{mpi-binding}
    function_name("MPI_Info_free")
    
    parameter("info", "INFO", direction="inout", desc=r"info object")
\end{mpi-binding}
...
\begin{mpi-binding}
    ...
    parameter("info", "INFO", direction="out", desc=r"info object")
\end{mpi-binding}
